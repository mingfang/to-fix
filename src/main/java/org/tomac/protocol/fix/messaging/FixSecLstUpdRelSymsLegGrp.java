...
public class FixSecLstUpdRelSymsLegGrp extends FixGroup {
	...
	public FixSecLstUpdRelSymsLegGrp() {
		super(FixTags.LEGSWAPTYPE_INT);
	...
	**/
	...
	public FixSecLstUpdRelSymsLegGrp clone ( FixSecLstUpdRelSymsLegGrp out ) {
		if ( hasLegSwapType())
