...
public class FixNestedParties2 extends FixGroup {
	...
	long nested2PartyRole = 0;		
		FixNstdPtys2SubGrp[] nstdPtys2SubGrp;
	...
	public void encode(ByteBuffer out) {
		...
		for (FixNstdPtys2SubGrp fixNstdPtys2SubGrp : nstdPtys2SubGrp) fixNstdPtys2SubGrp.encode(out);
	}
	...
	**/
	...
	public boolean equals(Object o) {
		...
		for (FixNstdPtys2SubGrp fixNstdPtys2SubGrp : nstdPtys2SubGrp)
			if (!fixNstdPtys2SubGrp.equals(msg.nstdPtys2SubGrp)) return false;
