...
public class FixCollateralInquiry extends FixMessage
{
	...
	public FixCollateralInquiry() {
		...
		msgType = MsgTypes.COLLATERALINQUIRY_INT;
	...
	public void getAll() throws FixSessionException, FixGarbledException
	{
		...
		while ( ( id = FixUtils.getTagId( buf ) ) >= 0 )
		{
			...
			case FixTags.COLLINQUIRYID_INT:
				collInquiryID = FixUtils.getTagStringValue(MsgTypes.COLLATERALINQUIRY ,id ,value, collInquiryID);
				break;

			case FixTags.NOCOLLINQUIRYQUALIFIER_INT:
				collInqQualGrp.noCollInquiryQualifier = FixUtils.getTagIntValue( MsgTypes.COLLATERALINQUIRY ,FixTags.NOCOLLINQUIRYQUALIFIER_INT ,value );
				collInqQualGrp.getAll(collInqQualGrp.noCollInquiryQualifier, value );
				break;

			case FixTags.SUBSCRIPTIONREQUESTTYPE_INT:
				subscriptionRequestType = FixUtils.getTagCharValue(MsgTypes.COLLATERALINQUIRY ,id ,value );
			...
			case FixTags.RESPONSETRANSPORTTYPE_INT:
				responseTransportType = FixUtils.getTagIntValue(MsgTypes.COLLATERALINQUIRY ,id ,value );
			...
			case FixTags.RESPONSEDESTINATION_INT:
				responseDestination = FixUtils.getTagStringValue(MsgTypes.COLLATERALINQUIRY ,id ,value, responseDestination);
				break;

			case FixTags.NOPARTYIDS_INT:
				parties.noPartyIDs = FixUtils.getTagIntValue( MsgTypes.COLLATERALINQUIRY ,FixTags.NOPARTYIDS_INT ,value );
				parties.getAll(parties.noPartyIDs, value );
				break;

			case FixTags.ACCOUNT_INT:
				account = FixUtils.getTagStringValue(MsgTypes.COLLATERALINQUIRY ,id ,value, account);
				break;

			case FixTags.ACCOUNTTYPE_INT:
				accountType = FixUtils.getTagIntValue(MsgTypes.COLLATERALINQUIRY ,id ,value );
			...
			case FixTags.CLORDID_INT:
				clOrdID = FixUtils.getTagStringValue(MsgTypes.COLLATERALINQUIRY ,id ,value, clOrdID);
				break;

			case FixTags.ORDERID_INT:
				orderID = FixUtils.getTagStringValue(MsgTypes.COLLATERALINQUIRY ,id ,value, orderID);
				break;

			case FixTags.SECONDARYORDERID_INT:
				secondaryOrderID = FixUtils.getTagStringValue(MsgTypes.COLLATERALINQUIRY ,id ,value, secondaryOrderID);
				break;

			case FixTags.SECONDARYCLORDID_INT:
				secondaryClOrdID = FixUtils.getTagStringValue(MsgTypes.COLLATERALINQUIRY ,id ,value, secondaryClOrdID);
				break;

			case FixTags.NOEXECS_INT:
				execCollGrp.noExecs = FixUtils.getTagIntValue( MsgTypes.COLLATERALINQUIRY ,FixTags.NOEXECS_INT ,value );
				execCollGrp.getAll(execCollGrp.noExecs, value );
				break;

			case FixTags.NOTRADES_INT:
				trdCollGrp.noTrades = FixUtils.getTagIntValue( MsgTypes.COLLATERALINQUIRY ,FixTags.NOTRADES_INT ,value );
			...
			case FixTags.SETTLDATE_INT:
				settlDate = FixUtils.getTagStringValue(MsgTypes.COLLATERALINQUIRY ,id ,value, settlDate);
				break;

			case FixTags.QUANTITY_INT:
				quantity = FixUtils.getTagFloatValue(MsgTypes.COLLATERALINQUIRY ,id ,value);
				break;

			case FixTags.QTYTYPE_INT:
				qtyType = FixUtils.getTagIntValue(MsgTypes.COLLATERALINQUIRY ,id ,value );
			...
			case FixTags.CURRENCY_INT:
				currency = FixUtils.getTagStringValue(MsgTypes.COLLATERALINQUIRY ,id ,value, currency);
				break;

			case FixTags.NOLEGS_INT:
				instrmtLegGrp.noLegs = FixUtils.getTagIntValue( MsgTypes.COLLATERALINQUIRY ,FixTags.NOLEGS_INT ,value );
				instrmtLegGrp.getAll(instrmtLegGrp.noLegs, value );
				break;

			case FixTags.NOUNDERLYINGS_INT:
				undInstrmtGrp.noUnderlyings = FixUtils.getTagIntValue( MsgTypes.COLLATERALINQUIRY ,FixTags.NOUNDERLYINGS_INT ,value );
				undInstrmtGrp.getAll(undInstrmtGrp.noUnderlyings, value );
				break;

			case FixTags.MARGINEXCESS_INT:
				marginExcess = FixUtils.getTagFloatValue(MsgTypes.COLLATERALINQUIRY ,id ,value);
				break;

			case FixTags.TOTALNETVALUE_INT:
				totalNetValue = FixUtils.getTagFloatValue(MsgTypes.COLLATERALINQUIRY ,id ,value);
				break;

			case FixTags.CASHOUTSTANDING_INT:
				cashOutstanding = FixUtils.getTagFloatValue(MsgTypes.COLLATERALINQUIRY ,id ,value);
				break;

			case FixTags.NOTRDREGTIMESTAMPS_INT:
				trdRegTimestamps.noTrdRegTimestamps = FixUtils.getTagIntValue( MsgTypes.COLLATERALINQUIRY ,FixTags.NOTRDREGTIMESTAMPS_INT ,value );
				trdRegTimestamps.getAll(trdRegTimestamps.noTrdRegTimestamps, value );
				break;

			case FixTags.SIDE_INT:
				side = FixUtils.getTagCharValue(MsgTypes.COLLATERALINQUIRY ,id ,value );
			...
			case FixTags.PRICE_INT:
				price = FixUtils.getTagFloatValue(MsgTypes.COLLATERALINQUIRY ,id ,value);
				break;

			case FixTags.PRICETYPE_INT:
				priceType = FixUtils.getTagIntValue(MsgTypes.COLLATERALINQUIRY ,id ,value );
			...
			case FixTags.ACCRUEDINTERESTAMT_INT:
				accruedInterestAmt = FixUtils.getTagFloatValue(MsgTypes.COLLATERALINQUIRY ,id ,value);
				break;

			case FixTags.ENDACCRUEDINTERESTAMT_INT:
				endAccruedInterestAmt = FixUtils.getTagFloatValue(MsgTypes.COLLATERALINQUIRY ,id ,value);
				break;

			case FixTags.STARTCASH_INT:
				startCash = FixUtils.getTagFloatValue(MsgTypes.COLLATERALINQUIRY ,id ,value);
				break;

			case FixTags.ENDCASH_INT:
				endCash = FixUtils.getTagFloatValue(MsgTypes.COLLATERALINQUIRY ,id ,value);
				break;
			...
			case FixTags.NOSTIPULATIONS_INT:
				stipulations.noStipulations = FixUtils.getTagIntValue( MsgTypes.COLLATERALINQUIRY ,FixTags.NOSTIPULATIONS_INT ,value );
			...
			case FixTags.TRADINGSESSIONID_INT:
				tradingSessionID = FixUtils.getTagStringValue(MsgTypes.COLLATERALINQUIRY ,id ,value, tradingSessionID);
			...
			case FixTags.TRADINGSESSIONSUBID_INT:
				tradingSessionSubID = FixUtils.getTagStringValue(MsgTypes.COLLATERALINQUIRY ,id ,value, tradingSessionSubID);
			...
			case FixTags.SETTLSESSID_INT:
				settlSessID = FixUtils.getTagStringValue(MsgTypes.COLLATERALINQUIRY ,id ,value, settlSessID);
			...
			case FixTags.SETTLSESSSUBID_INT:
				settlSessSubID = FixUtils.getTagStringValue(MsgTypes.COLLATERALINQUIRY ,id ,value, settlSessSubID);
				break;

			case FixTags.CLEARINGBUSINESSDATE_INT:
				clearingBusinessDate = FixUtils.getTagStringValue(MsgTypes.COLLATERALINQUIRY ,id ,value, clearingBusinessDate);
				break;

			case FixTags.TEXT_INT:
				text = FixUtils.getTagStringValue(MsgTypes.COLLATERALINQUIRY ,id ,value, text);
				break;

			case FixTags.ENCODEDTEXTLEN_INT:
				encodedTextLen = FixUtils.getTagIntValue(MsgTypes.COLLATERALINQUIRY ,id ,value );
				break;

			case FixTags.ENCODEDTEXT_INT:
				encodedText = FixUtils.getTagStringValue(MsgTypes.COLLATERALINQUIRY ,id ,value, encodedText);
				break;

			// for a message always get the checksum
			case FixTags.CHECKSUM_INT:
				checkSum = FixUtils.getTagIntValue( MsgTypes.COLLATERALINQUIRY ,FixTags.CHECKSUM_INT, value );
	...
	public void encode( ByteBuffer out )
	{
		...
		FixUtils.putFixTag( out, FixTags.MSGTYPE_INT, MsgTypes.COLLATERALINQUIRY);
	...
	**/
	...
	public String toString() {
		...
		s += "MsgType(35)=" + new String(MsgTypes.COLLATERALINQUIRY) + sep;
