...
public class FixCollateralResponse extends FixMessage
{
	...
	public FixCollateralResponse() {
		...
		msgType = MsgTypes.COLLATERALRESPONSE_INT;
	...
	public void getAll() throws FixSessionException, FixGarbledException
	{
		...
		while ( ( id = FixUtils.getTagId( buf ) ) >= 0 )
		{
			...
			case FixTags.COLLRESPID_INT:
				collRespID = FixUtils.getTagStringValue(MsgTypes.COLLATERALRESPONSE ,id ,value, collRespID);
				break;

			case FixTags.COLLASGNID_INT:
				collAsgnID = FixUtils.getTagStringValue(MsgTypes.COLLATERALRESPONSE ,id ,value, collAsgnID);
				break;

			case FixTags.COLLREQID_INT:
				collReqID = FixUtils.getTagStringValue(MsgTypes.COLLATERALRESPONSE ,id ,value, collReqID);
				break;

			case FixTags.COLLASGNREASON_INT:
				collAsgnReason = FixUtils.getTagIntValue(MsgTypes.COLLATERALRESPONSE ,id ,value );
				if (!CollAsgnReason.isValid(collAsgnReason) ) throw new FixSessionException(SessionRejectReason.VALUE_IS_INCORRECT_OUT_OF_RANGE_FOR_THIS_TAG, ("Invalid enumerated value(" + collAsgnReason + ") for tag").getBytes(), id, FixUtils.getMsgType(msgType) );
				break;

			case FixTags.COLLASGNTRANSTYPE_INT:
				collAsgnTransType = FixUtils.getTagIntValue(MsgTypes.COLLATERALRESPONSE ,id ,value );
				if (!CollAsgnTransType.isValid(collAsgnTransType) ) throw new FixSessionException(SessionRejectReason.VALUE_IS_INCORRECT_OUT_OF_RANGE_FOR_THIS_TAG, ("Invalid enumerated value(" + collAsgnTransType + ") for tag").getBytes(), id, FixUtils.getMsgType(msgType) );
				break;

			case FixTags.COLLASGNRESPTYPE_INT:
				collAsgnRespType = FixUtils.getTagIntValue(MsgTypes.COLLATERALRESPONSE ,id ,value );
				if (!CollAsgnRespType.isValid(collAsgnRespType) ) throw new FixSessionException(SessionRejectReason.VALUE_IS_INCORRECT_OUT_OF_RANGE_FOR_THIS_TAG, ("Invalid enumerated value(" + collAsgnRespType + ") for tag").getBytes(), id, FixUtils.getMsgType(msgType) );
				break;

			case FixTags.COLLASGNREJECTREASON_INT:
				collAsgnRejectReason = FixUtils.getTagIntValue(MsgTypes.COLLATERALRESPONSE ,id ,value );
				if (!CollAsgnRejectReason.isValid(collAsgnRejectReason) ) throw new FixSessionException(SessionRejectReason.VALUE_IS_INCORRECT_OUT_OF_RANGE_FOR_THIS_TAG, ("Invalid enumerated value(" + collAsgnRejectReason + ") for tag").getBytes(), id, FixUtils.getMsgType(msgType) );
				break;

			case FixTags.TRANSACTTIME_INT:
				transactTime = FixUtils.getTagStringValue(MsgTypes.COLLATERALRESPONSE ,id ,value, transactTime);
				break;

			case FixTags.COLLAPPLTYPE_INT:
				collApplType = FixUtils.getTagIntValue(MsgTypes.COLLATERALRESPONSE ,id ,value );
			...
			case FixTags.FINANCIALSTATUS_INT:
				financialStatus = FixUtils.getTagStringValue(MsgTypes.COLLATERALRESPONSE ,id ,value, financialStatus);
			...
			case FixTags.CLEARINGBUSINESSDATE_INT:
				clearingBusinessDate = FixUtils.getTagStringValue(MsgTypes.COLLATERALRESPONSE ,id ,value, clearingBusinessDate);
				break;

			case FixTags.NOPARTYIDS_INT:
				parties.noPartyIDs = FixUtils.getTagIntValue( MsgTypes.COLLATERALRESPONSE ,FixTags.NOPARTYIDS_INT ,value );
				parties.getAll(parties.noPartyIDs, value );
				break;

			case FixTags.ACCOUNT_INT:
				account = FixUtils.getTagStringValue(MsgTypes.COLLATERALRESPONSE ,id ,value, account);
				break;

			case FixTags.ACCOUNTTYPE_INT:
				accountType = FixUtils.getTagIntValue(MsgTypes.COLLATERALRESPONSE ,id ,value );
			...
			case FixTags.CLORDID_INT:
				clOrdID = FixUtils.getTagStringValue(MsgTypes.COLLATERALRESPONSE ,id ,value, clOrdID);
				break;

			case FixTags.ORDERID_INT:
				orderID = FixUtils.getTagStringValue(MsgTypes.COLLATERALRESPONSE ,id ,value, orderID);
				break;

			case FixTags.SECONDARYORDERID_INT:
				secondaryOrderID = FixUtils.getTagStringValue(MsgTypes.COLLATERALRESPONSE ,id ,value, secondaryOrderID);
				break;

			case FixTags.SECONDARYCLORDID_INT:
				secondaryClOrdID = FixUtils.getTagStringValue(MsgTypes.COLLATERALRESPONSE ,id ,value, secondaryClOrdID);
				break;

			case FixTags.NOEXECS_INT:
				execCollGrp.noExecs = FixUtils.getTagIntValue( MsgTypes.COLLATERALRESPONSE ,FixTags.NOEXECS_INT ,value );
				execCollGrp.getAll(execCollGrp.noExecs, value );
				break;

			case FixTags.NOTRADES_INT:
				trdCollGrp.noTrades = FixUtils.getTagIntValue( MsgTypes.COLLATERALRESPONSE ,FixTags.NOTRADES_INT ,value );
			...
			case FixTags.SETTLDATE_INT:
				settlDate = FixUtils.getTagStringValue(MsgTypes.COLLATERALRESPONSE ,id ,value, settlDate);
				break;

			case FixTags.QUANTITY_INT:
				quantity = FixUtils.getTagFloatValue(MsgTypes.COLLATERALRESPONSE ,id ,value);
				break;

			case FixTags.QTYTYPE_INT:
				qtyType = FixUtils.getTagIntValue(MsgTypes.COLLATERALRESPONSE ,id ,value );
			...
			case FixTags.CURRENCY_INT:
				currency = FixUtils.getTagStringValue(MsgTypes.COLLATERALRESPONSE ,id ,value, currency);
				break;

			case FixTags.NOLEGS_INT:
				instrmtLegGrp.noLegs = FixUtils.getTagIntValue( MsgTypes.COLLATERALRESPONSE ,FixTags.NOLEGS_INT ,value );
				instrmtLegGrp.getAll(instrmtLegGrp.noLegs, value );
				break;

			case FixTags.NOUNDERLYINGS_INT:
				undInstrmtCollGrp.noUnderlyings = FixUtils.getTagIntValue( MsgTypes.COLLATERALRESPONSE ,FixTags.NOUNDERLYINGS_INT ,value );
				undInstrmtCollGrp.getAll(undInstrmtCollGrp.noUnderlyings, value );
				break;

			case FixTags.MARGINEXCESS_INT:
				marginExcess = FixUtils.getTagFloatValue(MsgTypes.COLLATERALRESPONSE ,id ,value);
				break;

			case FixTags.TOTALNETVALUE_INT:
				totalNetValue = FixUtils.getTagFloatValue(MsgTypes.COLLATERALRESPONSE ,id ,value);
				break;

			case FixTags.CASHOUTSTANDING_INT:
				cashOutstanding = FixUtils.getTagFloatValue(MsgTypes.COLLATERALRESPONSE ,id ,value);
				break;

			case FixTags.NOTRDREGTIMESTAMPS_INT:
				trdRegTimestamps.noTrdRegTimestamps = FixUtils.getTagIntValue( MsgTypes.COLLATERALRESPONSE ,FixTags.NOTRDREGTIMESTAMPS_INT ,value );
				trdRegTimestamps.getAll(trdRegTimestamps.noTrdRegTimestamps, value );
				break;

			case FixTags.SIDE_INT:
				side = FixUtils.getTagCharValue(MsgTypes.COLLATERALRESPONSE ,id ,value );
			...
			case FixTags.NOMISCFEES_INT:
				miscFeesGrp.noMiscFees = FixUtils.getTagIntValue( MsgTypes.COLLATERALRESPONSE ,FixTags.NOMISCFEES_INT ,value );
				miscFeesGrp.getAll(miscFeesGrp.noMiscFees, value );
				break;

			case FixTags.PRICE_INT:
				price = FixUtils.getTagFloatValue(MsgTypes.COLLATERALRESPONSE ,id ,value);
				break;

			case FixTags.PRICETYPE_INT:
				priceType = FixUtils.getTagIntValue(MsgTypes.COLLATERALRESPONSE ,id ,value );
			...
			case FixTags.ACCRUEDINTERESTAMT_INT:
				accruedInterestAmt = FixUtils.getTagFloatValue(MsgTypes.COLLATERALRESPONSE ,id ,value);
				break;

			case FixTags.ENDACCRUEDINTERESTAMT_INT:
				endAccruedInterestAmt = FixUtils.getTagFloatValue(MsgTypes.COLLATERALRESPONSE ,id ,value);
				break;

			case FixTags.STARTCASH_INT:
				startCash = FixUtils.getTagFloatValue(MsgTypes.COLLATERALRESPONSE ,id ,value);
				break;

			case FixTags.ENDCASH_INT:
				endCash = FixUtils.getTagFloatValue(MsgTypes.COLLATERALRESPONSE ,id ,value);
				break;
			...
			case FixTags.NOSTIPULATIONS_INT:
				stipulations.noStipulations = FixUtils.getTagIntValue( MsgTypes.COLLATERALRESPONSE ,FixTags.NOSTIPULATIONS_INT ,value );
				stipulations.getAll(stipulations.noStipulations, value );
				break;

			case FixTags.TEXT_INT:
				text = FixUtils.getTagStringValue(MsgTypes.COLLATERALRESPONSE ,id ,value, text);
				break;

			case FixTags.ENCODEDTEXTLEN_INT:
				encodedTextLen = FixUtils.getTagIntValue(MsgTypes.COLLATERALRESPONSE ,id ,value );
				break;

			case FixTags.ENCODEDTEXT_INT:
				encodedText = FixUtils.getTagStringValue(MsgTypes.COLLATERALRESPONSE ,id ,value, encodedText);
				break;

			// for a message always get the checksum
			case FixTags.CHECKSUM_INT:
				checkSum = FixUtils.getTagIntValue( MsgTypes.COLLATERALRESPONSE ,FixTags.CHECKSUM_INT, value );
	...
	public void encode( ByteBuffer out )
	{
		...
		FixUtils.putFixTag( out, FixTags.MSGTYPE_INT, MsgTypes.COLLATERALRESPONSE);
		...
		if (FixUtils.isSet(collAsgnReason)) FixUtils.putFixTag( out, FixTags.COLLASGNREASON_INT, collAsgnReason);
		if (FixUtils.isSet(collAsgnTransType)) FixUtils.putFixTag( out, FixTags.COLLASGNTRANSTYPE_INT, collAsgnTransType);
		FixUtils.putFixTag( out, FixTags.COLLASGNRESPTYPE_INT, collAsgnRespType);
		if (FixUtils.isSet(collAsgnRejectReason)) FixUtils.putFixTag( out, FixTags.COLLASGNREJECTREASON_INT, collAsgnRejectReason);
	...
	**/
	...
	public String toString() {
		...
		s += "MsgType(35)=" + new String(MsgTypes.COLLATERALRESPONSE) + sep;
		...
		try {
			...
			if (FixUtils.isSet(collAsgnReason)) s += "CollAsgnReason(895)=" + String.valueOf(collAsgnReason) + sep;
			if (FixUtils.isSet(collAsgnTransType)) s += "CollAsgnTransType(903)=" + String.valueOf(collAsgnTransType) + sep;
			 s += "CollAsgnRespType(905)=" + String.valueOf(collAsgnRespType) + sep;
			if (FixUtils.isSet(collAsgnRejectReason)) s += "CollAsgnRejectReason(906)=" + String.valueOf(collAsgnRejectReason) + sep;
	...
	public boolean equals(Object o) {
		...
		if (!Utils.equals( collRespID, msg.collRespID)) return false;
		...
		if (!( collAsgnRespType==msg.collAsgnRespType)) return false;

		if (!( collAsgnRejectReason==msg.collAsgnRejectReason)) return false;

		if (!( collApplType==msg.collApplType)) return false;
