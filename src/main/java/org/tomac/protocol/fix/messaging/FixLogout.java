...
public class FixLogout extends FixInMessage {
	...
	public FixLogout() {
		super(FixMessageInfo.MessageTypes.LOGOUT);
            	...
            	default:
        			if ( standardHeader.isKeyTag(tag)) {
                		...
                		if (err.hasError()) break; 		
                			...
                			err.setError((int)FixMessageInfo.SessionRejectReason.TAG_NOT_DEFINED_FOR_THIS_MESSAGE_TYPE, "Tag not defined for this message type", tag, FixMessageInfo.MessageTypes.LOGOUT_INT);
                			break;
                		}
					}
	...
	**/
	...
	public boolean equals(Object o) {
		if (! ( o instanceof FixLogout)) return false;

		FixLogout msg = (FixLogout) o;
	...
	public FixLogout clone ( FixLogout out ) {
		if ( hasSessionStatus())
