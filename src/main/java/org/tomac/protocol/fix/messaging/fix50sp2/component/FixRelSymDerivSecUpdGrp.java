...
public class FixRelSymDerivSecUpdGrp
{
	...
	public void getAll(int noRelatedSym, ByteBuffer buf) throws FixSessionException, FixGarbledException {
		...
		if (group == null || group.length < noRelatedSym) {
			group = new RelSymDerivSecUpdGrp[noRelatedSym];

			for ( int i = 0; i < noRelatedSym; i++ ) group[i] = new RelSymDerivSecUpdGrp();
	}
...
public class RelSymDerivSecUpdGrp implements FixComponent
{
	...
	public void getAllGroup(ByteBuffer buf) throws FixSessionException, FixGarbledException
	{
		...
		int lastTagPosition = buf.position();
			...
			if(id == FixTags.LISTUPDATEACTION_INT) {
				listUpdateAction = FixUtils.getTagCharValue(null ,id ,value );
	...
	**/
	...
	@Override
	public boolean equals(Object o) {
		if (! ( o instanceof RelSymDerivSecUpdGrp)) return false;

			RelSymDerivSecUpdGrp msg = (RelSymDerivSecUpdGrp) o;
