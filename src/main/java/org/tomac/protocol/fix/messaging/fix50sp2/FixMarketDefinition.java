...
public class FixMarketDefinition extends FixMessage
{
	...
	public FixMarketDefinition() {
		...
		msgType = MsgTypes.MARKETDEFINITION_INT;
	...
	public void encode( ByteBuffer out )
	{
		...
		FixUtils.putFixTag( out, FixTags.MSGTYPE_INT, MsgTypes.MARKETDEFINITION);
	...
	**/
	...
	public String toString() {
		...
		s += "MsgType(35)=" + new String(MsgTypes.MARKETDEFINITION) + sep;
