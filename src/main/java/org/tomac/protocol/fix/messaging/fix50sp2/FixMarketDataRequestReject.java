...
public class FixMarketDataRequestReject extends FixMessage
{
	...
	public FixMarketDataRequestReject() {
		...
		msgType = MsgTypes.MARKETDATAREQUESTREJECT_INT;
	...
	public void encode( ByteBuffer out )
	{
		...
		FixUtils.putFixTag( out, FixTags.MSGTYPE_INT, MsgTypes.MARKETDATAREQUESTREJECT);
	...
	**/
	...
	public String toString() {
		...
		s += "MsgType(35)=" + new String(MsgTypes.MARKETDATAREQUESTREJECT) + sep;
