...
public class FixLegQuotGrp extends FixGroup {
	...
	long legOfferForwardPoints = 0;		
		FixInstrumentLeg instrumentLeg;
		FixLegStipulations[] legStipulations;
		FixNestedParties[] nestedParties;
		FixLegBenchmarkCurveData legBenchmarkCurveData;
	...
	public void encode(ByteBuffer out) {
		...
		for (FixLegStipulations fixLegStipulations : legStipulations) fixLegStipulations.encode(out);
	...
	public long getLegPriceType() { 		
		if ( hasLegPriceType()) {		
			...
			legPriceType = FixMessage.getTagIntValue(buf, err);
	...
	public long getLegBidPx() { 		
		if ( hasLegBidPx()) {		
			...
			legBidPx = FixMessage.getTagFloatValue(buf, err);
	...
	public long getLegOfferPx() { 		
		if ( hasLegOfferPx()) {		
			...
			legOfferPx = FixMessage.getTagFloatValue(buf, err);
	...
	public long getLegBidForwardPoints() { 		
		if ( hasLegBidForwardPoints()) {		
			...
			legBidForwardPoints = FixMessage.getTagFloatValue(buf, err);
	...
	public long getLegOfferForwardPoints() { 		
		if ( hasLegOfferForwardPoints()) {		
			...
			legOfferForwardPoints = FixMessage.getTagFloatValue(buf, err);
