...
public class FixNewOrderSingle extends FixMessage
{
	...
	public FixNewOrderSingle() {
		...
		msgType = MsgTypes.NEWORDERSINGLE_INT;
	...
	public void getAll() throws FixSessionException, FixGarbledException
	{
		...
		while ( ( id = FixUtils.getTagId( buf ) ) >= 0 )
		{
			...
			case FixTags.CLORDID_INT:
				clOrdID = FixUtils.getTagStringValue(MsgTypes.NEWORDERSINGLE ,id ,value, clOrdID);
				break;

			case FixTags.SECONDARYCLORDID_INT:
				secondaryClOrdID = FixUtils.getTagStringValue(MsgTypes.NEWORDERSINGLE ,id ,value, secondaryClOrdID);
				break;

			case FixTags.CLORDLINKID_INT:
				clOrdLinkID = FixUtils.getTagStringValue(MsgTypes.NEWORDERSINGLE ,id ,value, clOrdLinkID);
				break;

			case FixTags.NOPARTYIDS_INT:
				parties.noPartyIDs = FixUtils.getTagIntValue( MsgTypes.NEWORDERSINGLE ,FixTags.NOPARTYIDS_INT ,value );
				parties.getAll(parties.noPartyIDs, value );
				break;

			case FixTags.TRADEORIGINATIONDATE_INT:
				tradeOriginationDate = FixUtils.getTagStringValue(MsgTypes.NEWORDERSINGLE ,id ,value, tradeOriginationDate);
				break;

			case FixTags.TRADEDATE_INT:
				tradeDate = FixUtils.getTagStringValue(MsgTypes.NEWORDERSINGLE ,id ,value, tradeDate);
				break;

			case FixTags.ACCOUNT_INT:
				account = FixUtils.getTagStringValue(MsgTypes.NEWORDERSINGLE ,id ,value, account);
				break;

			case FixTags.ACCTIDSOURCE_INT:
				acctIDSource = FixUtils.getTagIntValue(MsgTypes.NEWORDERSINGLE ,id ,value );
			...
			case FixTags.ACCOUNTTYPE_INT:
				accountType = FixUtils.getTagIntValue(MsgTypes.NEWORDERSINGLE ,id ,value );
			...
			case FixTags.DAYBOOKINGINST_INT:
				dayBookingInst = FixUtils.getTagCharValue(MsgTypes.NEWORDERSINGLE ,id ,value );
			...
			case FixTags.BOOKINGUNIT_INT:
				bookingUnit = FixUtils.getTagCharValue(MsgTypes.NEWORDERSINGLE ,id ,value );
			...
			case FixTags.PREALLOCMETHOD_INT:
				preallocMethod = FixUtils.getTagCharValue(MsgTypes.NEWORDERSINGLE ,id ,value );
			...
			case FixTags.ALLOCID_INT:
				allocID = FixUtils.getTagStringValue(MsgTypes.NEWORDERSINGLE ,id ,value, allocID);
				break;

			case FixTags.NOALLOCS_INT:
				preAllocGrp.noAllocs = FixUtils.getTagIntValue( MsgTypes.NEWORDERSINGLE ,FixTags.NOALLOCS_INT ,value );
				preAllocGrp.getAll(preAllocGrp.noAllocs, value );
				break;

			case FixTags.SETTLTYPE_INT:
				settlType = FixUtils.getTagStringValue(MsgTypes.NEWORDERSINGLE ,id ,value, settlType);
			...
			case FixTags.SETTLDATE_INT:
				settlDate = FixUtils.getTagStringValue(MsgTypes.NEWORDERSINGLE ,id ,value, settlDate);
				break;

			case FixTags.CASHMARGIN_INT:
				cashMargin = FixUtils.getTagCharValue(MsgTypes.NEWORDERSINGLE ,id ,value );
			...
			case FixTags.CLEARINGFEEINDICATOR_INT:
				clearingFeeIndicator = FixUtils.getTagStringValue(MsgTypes.NEWORDERSINGLE ,id ,value, clearingFeeIndicator);
			...
			case FixTags.HANDLINST_INT:
				handlInst = FixUtils.getTagCharValue(MsgTypes.NEWORDERSINGLE ,id ,value );
			...
			case FixTags.EXECINST_INT:
				execInst = FixUtils.getTagStringValue(MsgTypes.NEWORDERSINGLE ,id ,value, execInst);
			...
			case FixTags.MINQTY_INT:
				minQty = FixUtils.getTagFloatValue(MsgTypes.NEWORDERSINGLE ,id ,value);
				break;

			case FixTags.MATCHINCREMENT_INT:
				matchIncrement = FixUtils.getTagFloatValue(MsgTypes.NEWORDERSINGLE ,id ,value);
				break;

			case FixTags.MAXPRICELEVELS_INT:
				maxPriceLevels = FixUtils.getTagIntValue(MsgTypes.NEWORDERSINGLE ,id ,value );
				break;
			...
			case FixTags.MAXFLOOR_INT:
				maxFloor = FixUtils.getTagFloatValue(MsgTypes.NEWORDERSINGLE ,id ,value);
				break;

			case FixTags.EXDESTINATION_INT:
				exDestination = FixUtils.getTagStringValue(MsgTypes.NEWORDERSINGLE ,id ,value, exDestination);
				break;

			case FixTags.EXDESTINATIONIDSOURCE_INT:
				exDestinationIDSource = FixUtils.getTagCharValue(MsgTypes.NEWORDERSINGLE ,id ,value );
			...
			case FixTags.NOTRADINGSESSIONS_INT:
				trdgSesGrp.noTradingSessions = FixUtils.getTagIntValue( MsgTypes.NEWORDERSINGLE ,FixTags.NOTRADINGSESSIONS_INT ,value );
				trdgSesGrp.getAll(trdgSesGrp.noTradingSessions, value );
				break;

			case FixTags.PROCESSCODE_INT:
				processCode = FixUtils.getTagCharValue(MsgTypes.NEWORDERSINGLE ,id ,value );
			...
			case FixTags.NOUNDERLYINGS_INT:
				undInstrmtGrp.noUnderlyings = FixUtils.getTagIntValue( MsgTypes.NEWORDERSINGLE ,FixTags.NOUNDERLYINGS_INT ,value );
				undInstrmtGrp.getAll(undInstrmtGrp.noUnderlyings, value );
				break;

			case FixTags.PREVCLOSEPX_INT:
				prevClosePx = FixUtils.getTagFloatValue(MsgTypes.NEWORDERSINGLE ,id ,value);
				break;

			case FixTags.SIDE_INT:
				side = FixUtils.getTagCharValue(MsgTypes.NEWORDERSINGLE ,id ,value );
			...
			case FixTags.LOCATEREQD_INT:
				locateReqd = FixUtils.getTagBooleanValue(MsgTypes.NEWORDERSINGLE ,id ,value );
			...
			case FixTags.TRANSACTTIME_INT:
				transactTime = FixUtils.getTagStringValue(MsgTypes.NEWORDERSINGLE ,id ,value, transactTime);
				break;

			case FixTags.NOSTIPULATIONS_INT:
				stipulations.noStipulations = FixUtils.getTagIntValue( MsgTypes.NEWORDERSINGLE ,FixTags.NOSTIPULATIONS_INT ,value );
				stipulations.getAll(stipulations.noStipulations, value );
				break;

			case FixTags.QTYTYPE_INT:
				qtyType = FixUtils.getTagIntValue(MsgTypes.NEWORDERSINGLE ,id ,value );
			...
			case FixTags.ORDTYPE_INT:
				ordType = FixUtils.getTagCharValue(MsgTypes.NEWORDERSINGLE ,id ,value );
			...
			case FixTags.PRICETYPE_INT:
				priceType = FixUtils.getTagIntValue(MsgTypes.NEWORDERSINGLE ,id ,value );
			...
			case FixTags.PRICE_INT:
				price = FixUtils.getTagFloatValue(MsgTypes.NEWORDERSINGLE ,id ,value);
				break;

			case FixTags.PRICEPROTECTIONSCOPE_INT:
				priceProtectionScope = FixUtils.getTagCharValue(MsgTypes.NEWORDERSINGLE ,id ,value );
			...
			case FixTags.STOPPX_INT:
				stopPx = FixUtils.getTagFloatValue(MsgTypes.NEWORDERSINGLE ,id ,value);
				break;
			...
			case FixTags.CURRENCY_INT:
				currency = FixUtils.getTagStringValue(MsgTypes.NEWORDERSINGLE ,id ,value, currency);
				break;

			case FixTags.COMPLIANCEID_INT:
				complianceID = FixUtils.getTagStringValue(MsgTypes.NEWORDERSINGLE ,id ,value, complianceID);
				break;

			case FixTags.SOLICITEDFLAG_INT:
				solicitedFlag = FixUtils.getTagBooleanValue(MsgTypes.NEWORDERSINGLE ,id ,value );
			...
			case FixTags.IOIID_INT:
				iOIID = FixUtils.getTagStringValue(MsgTypes.NEWORDERSINGLE ,id ,value, iOIID);
				break;

			case FixTags.QUOTEID_INT:
				quoteID = FixUtils.getTagStringValue(MsgTypes.NEWORDERSINGLE ,id ,value, quoteID);
				break;

			case FixTags.TIMEINFORCE_INT:
				timeInForce = FixUtils.getTagCharValue(MsgTypes.NEWORDERSINGLE ,id ,value );
			...
			case FixTags.EFFECTIVETIME_INT:
				effectiveTime = FixUtils.getTagStringValue(MsgTypes.NEWORDERSINGLE ,id ,value, effectiveTime);
				break;

			case FixTags.EXPIREDATE_INT:
				expireDate = FixUtils.getTagStringValue(MsgTypes.NEWORDERSINGLE ,id ,value, expireDate);
				break;

			case FixTags.EXPIRETIME_INT:
				expireTime = FixUtils.getTagStringValue(MsgTypes.NEWORDERSINGLE ,id ,value, expireTime);
				break;

			case FixTags.GTBOOKINGINST_INT:
				gTBookingInst = FixUtils.getTagIntValue(MsgTypes.NEWORDERSINGLE ,id ,value );
			...
			case FixTags.ORDERCAPACITY_INT:
				orderCapacity = FixUtils.getTagCharValue(MsgTypes.NEWORDERSINGLE ,id ,value );
			...
			case FixTags.ORDERRESTRICTIONS_INT:
				orderRestrictions = FixUtils.getTagStringValue(MsgTypes.NEWORDERSINGLE ,id ,value, orderRestrictions);
			...
			case FixTags.PRETRADEANONYMITY_INT:
				preTradeAnonymity = FixUtils.getTagBooleanValue(MsgTypes.NEWORDERSINGLE ,id ,value );
				break;

			case FixTags.CUSTORDERCAPACITY_INT:
				custOrderCapacity = FixUtils.getTagIntValue(MsgTypes.NEWORDERSINGLE ,id ,value );
			...
			case FixTags.FOREXREQ_INT:
				forexReq = FixUtils.getTagBooleanValue(MsgTypes.NEWORDERSINGLE ,id ,value );
			...
			case FixTags.SETTLCURRENCY_INT:
				settlCurrency = FixUtils.getTagStringValue(MsgTypes.NEWORDERSINGLE ,id ,value, settlCurrency);
				break;

			case FixTags.BOOKINGTYPE_INT:
				bookingType = FixUtils.getTagIntValue(MsgTypes.NEWORDERSINGLE ,id ,value );
			...
			case FixTags.TEXT_INT:
				text = FixUtils.getTagStringValue(MsgTypes.NEWORDERSINGLE ,id ,value, text);
				break;

			case FixTags.ENCODEDTEXTLEN_INT:
				encodedTextLen = FixUtils.getTagIntValue(MsgTypes.NEWORDERSINGLE ,id ,value );
				break;

			case FixTags.ENCODEDTEXT_INT:
				encodedText = FixUtils.getTagStringValue(MsgTypes.NEWORDERSINGLE ,id ,value, encodedText);
				break;

			case FixTags.SETTLDATE2_INT:
				settlDate2 = FixUtils.getTagStringValue(MsgTypes.NEWORDERSINGLE ,id ,value, settlDate2);
				break;

			case FixTags.ORDERQTY2_INT:
				orderQty2 = FixUtils.getTagFloatValue(MsgTypes.NEWORDERSINGLE ,id ,value);
				break;

			case FixTags.PRICE2_INT:
				price2 = FixUtils.getTagFloatValue(MsgTypes.NEWORDERSINGLE ,id ,value);
				break;

			case FixTags.POSITIONEFFECT_INT:
				positionEffect = FixUtils.getTagCharValue(MsgTypes.NEWORDERSINGLE ,id ,value );
			...
			case FixTags.COVEREDORUNCOVERED_INT:
				coveredOrUncovered = FixUtils.getTagIntValue(MsgTypes.NEWORDERSINGLE ,id ,value );
			...
			case FixTags.MAXSHOW_INT:
				maxShow = FixUtils.getTagFloatValue(MsgTypes.NEWORDERSINGLE ,id ,value);
				break;
			...
			case FixTags.TARGETSTRATEGY_INT:
				targetStrategy = FixUtils.getTagIntValue(MsgTypes.NEWORDERSINGLE ,id ,value );
			...
			case FixTags.NOSTRATEGYPARAMETERS_INT:
				strategyParametersGrp.noStrategyParameters = FixUtils.getTagIntValue( MsgTypes.NEWORDERSINGLE ,FixTags.NOSTRATEGYPARAMETERS_INT ,value );
				strategyParametersGrp.getAll(strategyParametersGrp.noStrategyParameters, value );
				break;

			case FixTags.TARGETSTRATEGYPARAMETERS_INT:
				targetStrategyParameters = FixUtils.getTagStringValue(MsgTypes.NEWORDERSINGLE ,id ,value, targetStrategyParameters);
				break;

			case FixTags.PARTICIPATIONRATE_INT:
				participationRate = FixUtils.getTagFloatValue(MsgTypes.NEWORDERSINGLE ,id ,value);
				break;

			case FixTags.CANCELLATIONRIGHTS_INT:
				cancellationRights = FixUtils.getTagCharValue(MsgTypes.NEWORDERSINGLE ,id ,value );
			...
			case FixTags.MONEYLAUNDERINGSTATUS_INT:
				moneyLaunderingStatus = FixUtils.getTagCharValue(MsgTypes.NEWORDERSINGLE ,id ,value );
			...
			case FixTags.REGISTID_INT:
				registID = FixUtils.getTagStringValue(MsgTypes.NEWORDERSINGLE ,id ,value, registID);
				break;

			case FixTags.DESIGNATION_INT:
				designation = FixUtils.getTagStringValue(MsgTypes.NEWORDERSINGLE ,id ,value, designation);
				break;

			case FixTags.MANUALORDERINDICATOR_INT:
				manualOrderIndicator = FixUtils.getTagBooleanValue(MsgTypes.NEWORDERSINGLE ,id ,value );
				break;

			case FixTags.CUSTDIRECTEDORDER_INT:
				custDirectedOrder = FixUtils.getTagBooleanValue(MsgTypes.NEWORDERSINGLE ,id ,value );
				break;

			case FixTags.RECEIVEDDEPTID_INT:
				receivedDeptID = FixUtils.getTagStringValue(MsgTypes.NEWORDERSINGLE ,id ,value, receivedDeptID);
				break;

			case FixTags.CUSTORDERHANDLINGINST_INT:
				custOrderHandlingInst = FixUtils.getTagStringValue(MsgTypes.NEWORDERSINGLE ,id ,value, custOrderHandlingInst);
			...
			case FixTags.ORDERHANDLINGINSTSOURCE_INT:
				orderHandlingInstSource = FixUtils.getTagIntValue(MsgTypes.NEWORDERSINGLE ,id ,value );
			...
			case FixTags.REFORDERID_INT:
				refOrderID = FixUtils.getTagStringValue(MsgTypes.NEWORDERSINGLE ,id ,value, refOrderID);
				break;

			case FixTags.REFORDERIDSOURCE_INT:
				refOrderIDSource = FixUtils.getTagCharValue(MsgTypes.NEWORDERSINGLE ,id ,value );
				if (!RefOrderIDSource.isValid(refOrderIDSource) ) throw new FixSessionException(SessionRejectReason.VALUE_IS_INCORRECT_OUT_OF_RANGE_FOR_THIS_TAG, ("Invalid enumerated value(" + refOrderIDSource + ") for tag").getBytes(), id, FixUtils.getMsgType(msgType) );
				break;

			case FixTags.NOTRDREGTIMESTAMPS_INT:
				trdRegTimestamps.noTrdRegTimestamps = FixUtils.getTagIntValue( MsgTypes.NEWORDERSINGLE ,FixTags.NOTRDREGTIMESTAMPS_INT ,value );
				trdRegTimestamps.getAll(trdRegTimestamps.noTrdRegTimestamps, value );
				break;

			// for a message always get the checksum
			case FixTags.CHECKSUM_INT:
				checkSum = FixUtils.getTagIntValue( MsgTypes.NEWORDERSINGLE ,FixTags.CHECKSUM_INT, value );
	...
	public void encode( ByteBuffer out )
	{
		...
		FixUtils.putFixTag( out, FixTags.MSGTYPE_INT, MsgTypes.NEWORDERSINGLE);
	...
	**/
	...
	public String toString() {
		...
		s += "MsgType(35)=" + new String(MsgTypes.NEWORDERSINGLE) + sep;
