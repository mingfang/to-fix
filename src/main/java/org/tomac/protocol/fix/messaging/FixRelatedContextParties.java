...
public class FixRelatedContextParties extends FixGroup {
	...
	long relatedContextPartyRole = 0;		
		FixRelatedContextPtysSubGrp[] relatedContextPtysSubGrp;
	...
	public void encode(ByteBuffer out) {
		...
		for (FixRelatedContextPtysSubGrp fixRelatedContextPtysSubGrp : relatedContextPtysSubGrp) fixRelatedContextPtysSubGrp.encode(out);
	}
	...
	**/
	...
	public boolean equals(Object o) {
		...
		for (FixRelatedContextPtysSubGrp fixRelatedContextPtysSubGrp : relatedContextPtysSubGrp)
			if (!fixRelatedContextPtysSubGrp.equals(msg.relatedContextPtysSubGrp)) return false;
