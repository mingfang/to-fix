...
import org.tomac.protocol.fix.messaging.fix50sp2.component.FixRelSymDerivSecUpdGrp;

public class FixDerivativeSecurityListUpdateReport extends FixMessage
{
	...
	public FixDerivativeSecurityListUpdateReport() {
		...
		relSymDerivSecUpdGrp = new FixRelSymDerivSecUpdGrp();
		this.clear();

		msgType = MsgTypes.DERIVATIVESECURITYLISTUPDATEREPORT_INT;
	...
	public void encode( ByteBuffer out )
	{
		...
		FixUtils.putFixTag( out, FixTags.MSGTYPE_INT, MsgTypes.DERIVATIVESECURITYLISTUPDATEREPORT);
	...
	**/
	...
	public String toString() {
		...
		s += "MsgType(35)=" + new String(MsgTypes.DERIVATIVESECURITYLISTUPDATEREPORT) + sep;
	...
	public boolean equals(Object o) {
		...
		if (!relSymDerivSecUpdGrp.equals(msg.relSymDerivSecUpdGrp)) return false;
