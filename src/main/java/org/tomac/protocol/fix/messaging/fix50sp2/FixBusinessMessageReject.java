...
public class FixBusinessMessageReject extends FixMessage
{
	...
	public byte[] businessRejectRefID;
	public long businessRejectReason = 0;
	public byte[] text;
	...
	public FixBusinessMessageReject() {
		...
		msgType = MsgTypes.BUSINESSMESSAGEREJECT_INT;
	...
	public void clear()
	{
		...
		Utils.fill( businessRejectRefID, (byte)0 );
		businessRejectReason = Long.MAX_VALUE;		
	...
	public void getAll() throws FixSessionException, FixGarbledException
	{
		...
		while ( ( id = FixUtils.getTagId( buf ) ) > 0 )
		{
			...
			case FixTags.BUSINESSREJECTREASON_INT:
				...
				if (!BusinessRejectReason.isValid(businessRejectReason) ) throw new FixSessionException(buf, "Invalid enumerated value(" + businessRejectReason + ") for tag: " + id );
				break;
	...
	private int checkRequiredTags() {
		...
		if (! FixUtils.isSet(refMsgType) ) return FixTags.REFMSGTYPE_INT;
		if (! FixUtils.isSet(businessRejectReason) ) return FixTags.BUSINESSREJECTREASON_INT;
	...
	public void encode( ByteBuffer out )
	{
		...
		FixUtils.putFixTag( out, FixTags.MSGTYPE_INT, MsgTypes.BUSINESSMESSAGEREJECT);
		...
		if (FixUtils.isSet(refSeqNum)) FixUtils.putFixTag( out, FixTags.REFSEQNUM_INT, refSeqNum);
		FixUtils.putFixTag( out, FixTags.REFMSGTYPE_INT, refMsgType, 0, Utils.lastIndexTrim(refMsgType, (byte)0) );
		...
		if (FixUtils.isSet(businessRejectRefID)) FixUtils.putFixTag( out, FixTags.BUSINESSREJECTREFID_INT, businessRejectRefID, 0, Utils.lastIndexTrim(businessRejectRefID, (byte)0) );
		FixUtils.putFixTag( out, FixTags.BUSINESSREJECTREASON_INT, businessRejectReason);
	...
	**/
	...
	public String toString() {
		...
		s += "MsgType(35)=" + new String(MsgTypes.BUSINESSMESSAGEREJECT) + sep;
		...
		try {
			...
			if (FixUtils.isSet(refSeqNum)) s += "RefSeqNum(45)=" + String.valueOf(refSeqNum) + sep;
			 s += "RefMsgType(372)=" + new String(refMsgType) + sep;
			...
			if (FixUtils.isSet(businessRejectRefID)) s += "BusinessRejectRefID(379)=" + new String(businessRejectRefID) + sep;
			 s += "BusinessRejectReason(380)=" + String.valueOf(businessRejectReason) + sep;
	...
	public boolean equals(Object o) {
		...
		if (!Utils.equals( businessRejectRefID, msg.businessRejectRefID)) return false;

		if (!( businessRejectReason==msg.businessRejectReason)) return false;
