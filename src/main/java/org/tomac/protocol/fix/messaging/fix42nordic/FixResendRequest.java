...
public class FixResendRequest extends FixMessage
{
	...
	public long beginSeqNo = 0;
	public long endSeqNo = 0;
	...
	public FixResendRequest() {
		...
		msgType = MsgTypes.RESENDREQUEST_INT;
	...
	public void clear()
	{
		...
		beginSeqNo = Long.MAX_VALUE;		
		endSeqNo = Long.MAX_VALUE;		
	}
	...
	private int checkRequiredTags() {
		...
		if (! FixUtils.isSet(beginSeqNo) ) return FixTags.BEGINSEQNO_INT;
		if (! FixUtils.isSet(endSeqNo) ) return FixTags.ENDSEQNO_INT;
	...
	public void encode( ByteBuffer out )
	{
		...
		FixUtils.putFixTag( out, FixTags.MSGTYPE_INT, MsgTypes.RESENDREQUEST);
		...
		FixUtils.putFixTag( out, FixTags.BEGINSEQNO_INT, beginSeqNo);
		FixUtils.putFixTag( out, FixTags.ENDSEQNO_INT, endSeqNo);
	...
	**/
	...
	public String toString() {
		...
		s += "MsgType(35)=" + new String(MsgTypes.RESENDREQUEST) + sep;
		...
		try {
			...
			if (FixUtils.isSet(deliverToSubID)) s += "DeliverToSubID(129)=" + new String(deliverToSubID) + sep;
			 ...
			 s += "BeginSeqNo(7)=" + String.valueOf(beginSeqNo) + sep;
			 s += "EndSeqNo(16)=" + String.valueOf(endSeqNo) + sep;
	...
	public boolean equals(Object o) {
		...
		if (!( beginSeqNo==msg.beginSeqNo)) return false;

		if (!( endSeqNo==msg.endSeqNo)) return false;
