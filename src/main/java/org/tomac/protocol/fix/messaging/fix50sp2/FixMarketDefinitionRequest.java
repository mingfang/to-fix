...
public class FixMarketDefinitionRequest extends FixMessage
{
	...
	public FixMarketDefinitionRequest() {
		...
		msgType = MsgTypes.MARKETDEFINITIONREQUEST_INT;
	...
	public void encode( ByteBuffer out )
	{
		...
		FixUtils.putFixTag( out, FixTags.MSGTYPE_INT, MsgTypes.MARKETDEFINITIONREQUEST);
	...
	**/
	...
	public String toString() {
		...
		s += "MsgType(35)=" + new String(MsgTypes.MARKETDEFINITIONREQUEST) + sep;
