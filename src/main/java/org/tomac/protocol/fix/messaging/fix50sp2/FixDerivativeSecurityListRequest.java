...
public class FixDerivativeSecurityListRequest extends FixMessage
{
	...
	public FixDerivativeSecurityListRequest() {
		...
		msgType = MsgTypes.DERIVATIVESECURITYLISTREQUEST_INT;
	...
	public void encode( ByteBuffer out )
	{
		...
		FixUtils.putFixTag( out, FixTags.MSGTYPE_INT, MsgTypes.DERIVATIVESECURITYLISTREQUEST);
	...
	**/
	...
	public String toString() {
		...
		s += "MsgType(35)=" + new String(MsgTypes.DERIVATIVESECURITYLISTREQUEST) + sep;
