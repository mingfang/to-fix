...
public class FixSecLstUpdRelSymsLegGrp
{
	...
	public void getAll(int noLegs, ByteBuffer buf) throws FixSessionException, FixGarbledException {
		...
		if (group == null || group.length < noLegs) {
			group = new SecLstUpdRelSymsLegGrp[noLegs];

			for ( int i = 0; i < noLegs; i++ ) group[i] = new SecLstUpdRelSymsLegGrp();
	}
...
public class SecLstUpdRelSymsLegGrp implements FixComponent
{
