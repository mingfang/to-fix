...
public class FixTrdInstrmtLegGrp extends FixGroup {
	...
	long legLastQty = 0;		
		...
		FixTradeCapLegUnderlyingsGrp[] tradeCapLegUnderlyingsGrp;
	...
	public void encode(ByteBuffer out) {
		...
		for (FixTradeCapLegUnderlyingsGrp fixTradeCapLegUnderlyingsGrp : tradeCapLegUnderlyingsGrp) fixTradeCapLegUnderlyingsGrp.encode(out);
	}
	...
	**/
	...
	public boolean equals(Object o) {
		...
		for (FixTradeCapLegUnderlyingsGrp fixTradeCapLegUnderlyingsGrp : tradeCapLegUnderlyingsGrp)
			if (!fixTradeCapLegUnderlyingsGrp.equals(msg.tradeCapLegUnderlyingsGrp)) return false;
