	...
	public void getAll() throws FixSessionException, IllegalStateException
	{
		...
		while ( ( id = FixUtils.getTagId( buf ) ) > 0 )
		{
			...
			case FixTags.QUOTESTATUS_INT:
				quoteStatus = FixUtils.getTagIntValue( value );
				if (!QuoteStatus.isValid(quoteStatus) ) throw new FixSessionException(buf, "Invalid enumerated value(" + quoteStatus + ") for tag: " + id );
				break;

			case FixTags.QUOTEREJECTREASON_INT:
				quoteRejectReason = FixUtils.getTagIntValue( value );
				if (!QuoteRejectReason.isValid(quoteRejectReason) ) throw new FixSessionException(buf, "Invalid enumerated value(" + quoteRejectReason + ") for tag: " + id );
				break;
