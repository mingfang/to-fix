...
public class FixReject extends FixMessage
{
	...
	private int checkRequiredTags() {
		...
		if (! FixUtils.isSet(sessionRejectReason) ) return FixTags.SESSIONREJECTREASON_INT;
		return tag;
	...
	public void encode( ByteBuffer out )
	{
		...
		FixUtils.putFixTag( out, FixTags.SESSIONREJECTREASON_INT, sessionRejectReason);
	...
	public String toString() {
		...
		try {
			...
			if (FixUtils.isSet(refMsgType)) s += "RefMsgType(372)=" + new String(refMsgType) + sep;
			 s += "SessionRejectReason(373)=" + String.valueOf(sessionRejectReason) + sep;
