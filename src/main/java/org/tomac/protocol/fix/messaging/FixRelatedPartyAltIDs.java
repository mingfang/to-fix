...
public class FixRelatedPartyAltIDs extends FixGroup {
	...
	byte relatedPartyAltIDSource = (byte)' ';		
		FixRelatedAltPtysSubGrp[] relatedAltPtysSubGrp;
	...
	public void encode(ByteBuffer out) {
		...
		for (FixRelatedAltPtysSubGrp fixRelatedAltPtysSubGrp : relatedAltPtysSubGrp) fixRelatedAltPtysSubGrp.encode(out);
	}
	...
	public byte[] getRelatedPartyAltID() { 		
		if ( hasRelatedPartyAltID()) {		
			...
			FixMessage.getTagStringValue(buf, relatedPartyAltID, 0, relatedPartyAltID.length, err);
	...
	public byte getRelatedPartyAltIDSource() { 		
		if ( hasRelatedPartyAltIDSource()) {		
			...
			relatedPartyAltIDSource = FixMessage.getTagCharValue(buf, err);
	...
	**/
	...
	public boolean equals(Object o) {
		...
		for (FixRelatedAltPtysSubGrp fixRelatedAltPtysSubGrp : relatedAltPtysSubGrp)
			if (!fixRelatedAltPtysSubGrp.equals(msg.relatedAltPtysSubGrp)) return false;
