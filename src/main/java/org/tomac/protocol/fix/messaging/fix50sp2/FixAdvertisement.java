	...
	public void getAll() throws FixSessionException, FixGarbledException
	{
		...
		while ( ( id = FixUtils.getTagId( buf ) ) > 0 )
		{
			...
			case FixTags.ADVTRANSTYPE_INT:
				...
				if (!AdvTransType.isValid(advTransType) ) throw new FixSessionException(buf, "Invalid enumerated value(" + advTransType + ") for tag: " + id );
				break;
			...
			case FixTags.ADVSIDE_INT:
				...
				if (!AdvSide.isValid(advSide) ) throw new FixSessionException(buf, "Invalid enumerated value(" + advSide + ") for tag: " + id );
				break;
