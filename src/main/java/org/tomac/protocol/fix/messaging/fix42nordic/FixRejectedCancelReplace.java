...
public class FixRejectedCancelReplace extends FixMessage
{
	...
	public FixRejectedCancelReplace() {
		...
		msgType = MsgTypes.REJECTEDCANCELREPLACE_INT;
	...
	public void getAll() throws FixSessionException, FixGarbledException
	{
		...
		while ( ( id = FixUtils.getTagId( buf ) ) >= 0 )
		{
			...
			case FixTags.CLORDID_INT:
				clOrdID = FixUtils.getTagStringValue(MsgTypes.REJECTEDCANCELREPLACE ,id ,value, clOrdID);
				break;

			case FixTags.ORDERID_INT:
				orderID = FixUtils.getTagStringValue(MsgTypes.REJECTEDCANCELREPLACE ,id ,value, orderID);
				break;

			case FixTags.ORDSTATUS_INT:
				ordStatus = FixUtils.getTagCharValue(MsgTypes.REJECTEDCANCELREPLACE ,id ,value );
			...
			case FixTags.ORIGCLORDID_INT:
				origClOrdID = FixUtils.getTagStringValue(MsgTypes.REJECTEDCANCELREPLACE ,id ,value, origClOrdID);
				break;

			case FixTags.TEXT_INT:
				text = FixUtils.getTagStringValue(MsgTypes.REJECTEDCANCELREPLACE ,id ,value, text);
				break;

			case FixTags.CXLREJREASON_INT:
				cxlRejReason = FixUtils.getTagIntValue(MsgTypes.REJECTEDCANCELREPLACE ,id ,value );
			...
			case FixTags.CLIENTID_INT:
				clientID = FixUtils.getTagStringValue(MsgTypes.REJECTEDCANCELREPLACE ,id ,value, clientID);
				break;

			case FixTags.CXLREJRESPONSETO_INT:
				cxlRejResponseTo = FixUtils.getTagCharValue(MsgTypes.REJECTEDCANCELREPLACE ,id ,value );
			...
			case FixTags.CHECKSUM_INT:
				checkSum = FixUtils.getTagIntValue( MsgTypes.REJECTEDCANCELREPLACE ,FixTags.CHECKSUM_INT, value );
	...
	public void encode( ByteBuffer out )
	{
		...
		FixUtils.putFixTag( out, FixTags.MSGTYPE_INT, MsgTypes.REJECTEDCANCELREPLACE);
	...
	**/
	...
	public String toString() {
		...
		s += "MsgType(35)=" + new String(MsgTypes.REJECTEDCANCELREPLACE) + sep;
