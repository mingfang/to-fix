...
public class FixOrderMassCancelReport extends FixInMessage {
	...
	FixAffectedOrdGrp[] affectedOrdGrp;
	FixNotAffectedOrdersGrp[] notAffectedOrdersGrp;
	FixParties[] parties;
	...
	public byte getMassCancelResponse() { 		
		if ( hasMassCancelResponse()) {		
			...
			massCancelResponse = FixMessage.getTagCharValue(buf, err);
	...
	public long getMassCancelRejectReason() { 		
		if ( hasMassCancelRejectReason()) {		
			...
			massCancelRejectReason = FixMessage.getTagIntValue(buf, err);
