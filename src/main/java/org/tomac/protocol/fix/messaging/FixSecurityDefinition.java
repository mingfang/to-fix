...
public class FixSecurityDefinition extends FixInMessage {
	...
	public FixSecurityDefinition() {
		super(FixMessageInfo.MessageTypes.SECURITYDEFINITION);
            	...
            	default:
        			if ( standardHeader.isKeyTag(tag)) {
                		...
                		if (err.hasError()) break; 		
                			...
                			err.setError((int)FixMessageInfo.SessionRejectReason.TAG_NOT_DEFINED_FOR_THIS_MESSAGE_TYPE, "Tag not defined for this message type", tag, FixMessageInfo.MessageTypes.SECURITYDEFINITION);
                			break;
                		}
					}
	...
	**/
	...
	public boolean equals(Object o) {
		if (! ( o instanceof FixSecurityDefinition)) return false;

		FixSecurityDefinition msg = (FixSecurityDefinition) o;
	...
	@Override
	public FixSecurityDefinition clone () {
		FixSecurityDefinition out = new FixSecurityDefinition();
	...
	public FixSecurityDefinition clone ( FixSecurityDefinition out ) {
		if ( hasSecurityReportID())
