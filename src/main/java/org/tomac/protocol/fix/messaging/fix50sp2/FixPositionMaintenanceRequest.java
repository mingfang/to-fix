...
public class FixPositionMaintenanceRequest extends FixMessage
{
	...
	public FixPositionMaintenanceRequest() {
		...
		msgType = MsgTypes.POSITIONMAINTENANCEREQUEST_INT;
	...
	public void getAll() throws FixSessionException, FixGarbledException
	{
		...
		while ( ( id = FixUtils.getTagId( buf ) ) >= 0 )
		{
			...
			case FixTags.POSREQID_INT:
				posReqID = FixUtils.getTagStringValue(MsgTypes.POSITIONMAINTENANCEREQUEST ,id ,value, posReqID);
				break;

			case FixTags.POSTRANSTYPE_INT:
				posTransType = FixUtils.getTagIntValue(MsgTypes.POSITIONMAINTENANCEREQUEST ,id ,value );
			...
			case FixTags.POSMAINTACTION_INT:
				posMaintAction = FixUtils.getTagIntValue(MsgTypes.POSITIONMAINTENANCEREQUEST ,id ,value );
			...
			case FixTags.ORIGPOSREQREFID_INT:
				origPosReqRefID = FixUtils.getTagStringValue(MsgTypes.POSITIONMAINTENANCEREQUEST ,id ,value, origPosReqRefID);
				break;

			case FixTags.POSMAINTRPTREFID_INT:
				posMaintRptRefID = FixUtils.getTagStringValue(MsgTypes.POSITIONMAINTENANCEREQUEST ,id ,value, posMaintRptRefID);
				break;

			case FixTags.CLEARINGBUSINESSDATE_INT:
				clearingBusinessDate = FixUtils.getTagStringValue(MsgTypes.POSITIONMAINTENANCEREQUEST ,id ,value, clearingBusinessDate);
				break;

			case FixTags.SETTLSESSID_INT:
				settlSessID = FixUtils.getTagStringValue(MsgTypes.POSITIONMAINTENANCEREQUEST ,id ,value, settlSessID);
			...
			case FixTags.SETTLSESSSUBID_INT:
				settlSessSubID = FixUtils.getTagStringValue(MsgTypes.POSITIONMAINTENANCEREQUEST ,id ,value, settlSessSubID);
				break;

			case FixTags.NOPARTYIDS_INT:
				parties.noPartyIDs = FixUtils.getTagIntValue( MsgTypes.POSITIONMAINTENANCEREQUEST ,FixTags.NOPARTYIDS_INT ,value );
				parties.getAll(parties.noPartyIDs, value );
				break;

			case FixTags.ACCOUNT_INT:
				account = FixUtils.getTagStringValue(MsgTypes.POSITIONMAINTENANCEREQUEST ,id ,value, account);
				break;

			case FixTags.ACCTIDSOURCE_INT:
				acctIDSource = FixUtils.getTagIntValue(MsgTypes.POSITIONMAINTENANCEREQUEST ,id ,value );
			...
			case FixTags.ACCOUNTTYPE_INT:
				accountType = FixUtils.getTagIntValue(MsgTypes.POSITIONMAINTENANCEREQUEST ,id ,value );
			...
			case FixTags.CURRENCY_INT:
				currency = FixUtils.getTagStringValue(MsgTypes.POSITIONMAINTENANCEREQUEST ,id ,value, currency);
				break;

			case FixTags.NOLEGS_INT:
				instrmtLegGrp.noLegs = FixUtils.getTagIntValue( MsgTypes.POSITIONMAINTENANCEREQUEST ,FixTags.NOLEGS_INT ,value );
				instrmtLegGrp.getAll(instrmtLegGrp.noLegs, value );
				break;

			case FixTags.NOUNDERLYINGS_INT:
				undInstrmtGrp.noUnderlyings = FixUtils.getTagIntValue( MsgTypes.POSITIONMAINTENANCEREQUEST ,FixTags.NOUNDERLYINGS_INT ,value );
				undInstrmtGrp.getAll(undInstrmtGrp.noUnderlyings, value );
				break;

			case FixTags.NOTRADINGSESSIONS_INT:
				trdgSesGrp.noTradingSessions = FixUtils.getTagIntValue( MsgTypes.POSITIONMAINTENANCEREQUEST ,FixTags.NOTRADINGSESSIONS_INT ,value );
				trdgSesGrp.getAll(trdgSesGrp.noTradingSessions, value );
				break;

			case FixTags.TRANSACTTIME_INT:
				transactTime = FixUtils.getTagStringValue(MsgTypes.POSITIONMAINTENANCEREQUEST ,id ,value, transactTime);
				break;

			case FixTags.NOPOSITIONS_INT:
				positionQty.noPositions = FixUtils.getTagIntValue( MsgTypes.POSITIONMAINTENANCEREQUEST ,FixTags.NOPOSITIONS_INT ,value );
				positionQty.getAll(positionQty.noPositions, value );
				break;

			case FixTags.NOPOSAMT_INT:
				positionAmountData.noPosAmt = FixUtils.getTagIntValue( MsgTypes.POSITIONMAINTENANCEREQUEST ,FixTags.NOPOSAMT_INT ,value );
				positionAmountData.getAll(positionAmountData.noPosAmt, value );
				break;

			case FixTags.ADJUSTMENTTYPE_INT:
				adjustmentType = FixUtils.getTagIntValue(MsgTypes.POSITIONMAINTENANCEREQUEST ,id ,value );
			...
			case FixTags.CONTRARYINSTRUCTIONINDICATOR_INT:
				contraryInstructionIndicator = FixUtils.getTagBooleanValue(MsgTypes.POSITIONMAINTENANCEREQUEST ,id ,value );
				break;

			case FixTags.PRIORSPREADINDICATOR_INT:
				priorSpreadIndicator = FixUtils.getTagBooleanValue(MsgTypes.POSITIONMAINTENANCEREQUEST ,id ,value );
				break;

			case FixTags.THRESHOLDAMOUNT_INT:
				thresholdAmount = FixUtils.getTagFloatValue(MsgTypes.POSITIONMAINTENANCEREQUEST ,id ,value);
				break;

			case FixTags.TEXT_INT:
				text = FixUtils.getTagStringValue(MsgTypes.POSITIONMAINTENANCEREQUEST ,id ,value, text);
				break;

			case FixTags.ENCODEDTEXTLEN_INT:
				encodedTextLen = FixUtils.getTagIntValue(MsgTypes.POSITIONMAINTENANCEREQUEST ,id ,value );
				break;

			case FixTags.ENCODEDTEXT_INT:
				encodedText = FixUtils.getTagStringValue(MsgTypes.POSITIONMAINTENANCEREQUEST ,id ,value, encodedText);
				break;

			case FixTags.SETTLCURRENCY_INT:
				settlCurrency = FixUtils.getTagStringValue(MsgTypes.POSITIONMAINTENANCEREQUEST ,id ,value, settlCurrency);
				break;

			// for a message always get the checksum
			case FixTags.CHECKSUM_INT:
				checkSum = FixUtils.getTagIntValue( MsgTypes.POSITIONMAINTENANCEREQUEST ,FixTags.CHECKSUM_INT, value );
	...
	public void encode( ByteBuffer out )
	{
		...
		FixUtils.putFixTag( out, FixTags.MSGTYPE_INT, MsgTypes.POSITIONMAINTENANCEREQUEST);
	...
	**/
	...
	public String toString() {
		...
		s += "MsgType(35)=" + new String(MsgTypes.POSITIONMAINTENANCEREQUEST) + sep;
