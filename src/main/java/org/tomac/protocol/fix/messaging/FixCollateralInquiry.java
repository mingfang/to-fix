...
public class FixCollateralInquiry extends FixInMessage {
	...
	public FixCollateralInquiry() {
		super(FixMessageInfo.MessageTypes.COLLATERALINQUIRY);
            	...
            	default:
        			if ( standardHeader.isKeyTag(tag)) {
                		...
                		if (err.hasError()) break; 		
                			...
                			err.setError((int)FixMessageInfo.SessionRejectReason.TAG_NOT_DEFINED_FOR_THIS_MESSAGE_TYPE, "Tag not defined for this message type", tag, FixMessageInfo.MessageTypes.COLLATERALINQUIRY);
                			break;
                		}
					}
	...
	public boolean hasRequiredTags(FixValidationError err) {
		...
		if (!hasCollInquiryID()) { 
			err.setError((int)FixMessageInfo.SessionRejectReason.REQUIRED_TAG_MISSING, "Required tag missing", FixTags.COLLINQUIRYID_INT, FixMessageInfo.MessageTypes.COLLATERALINQUIRY);
			return false;
		}
	...
	**/
	...
	public boolean equals(Object o) {
		if (! ( o instanceof FixCollateralInquiry)) return false;

		FixCollateralInquiry msg = (FixCollateralInquiry) o;
	...
	@Override
	public FixCollateralInquiry clone () {
		FixCollateralInquiry out = new FixCollateralInquiry();
	...
	public FixCollateralInquiry clone ( FixCollateralInquiry out ) {
		if ( hasCollInquiryID())
