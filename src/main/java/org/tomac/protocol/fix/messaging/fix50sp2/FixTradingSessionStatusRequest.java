	...
	public void getAll() throws FixSessionException, FixGarbledException
	{
		...
		while ( ( id = FixUtils.getTagId( buf ) ) >= 0 )
		{
			...
			case FixTags.TRADSESREQID_INT:
				tradSesReqID = FixUtils.getTagStringValue(MsgTypes.TRADINGSESSIONSTATUSREQUEST ,id ,value, tradSesReqID);
				break;

			case FixTags.MARKETID_INT:
				marketID = FixUtils.getTagStringValue(MsgTypes.TRADINGSESSIONSTATUSREQUEST ,id ,value, marketID);
				break;

			case FixTags.MARKETSEGMENTID_INT:
				marketSegmentID = FixUtils.getTagStringValue(MsgTypes.TRADINGSESSIONSTATUSREQUEST ,id ,value, marketSegmentID);
				break;

			case FixTags.TRADINGSESSIONID_INT:
				tradingSessionID = FixUtils.getTagStringValue(MsgTypes.TRADINGSESSIONSTATUSREQUEST ,id ,value, tradingSessionID);
			...
			case FixTags.TRADINGSESSIONSUBID_INT:
				tradingSessionSubID = FixUtils.getTagStringValue(MsgTypes.TRADINGSESSIONSTATUSREQUEST ,id ,value, tradingSessionSubID);
			...
			case FixTags.TRADSESMETHOD_INT:
				tradSesMethod = FixUtils.getTagIntValue(MsgTypes.TRADINGSESSIONSTATUSREQUEST ,id ,value );
			...
			case FixTags.TRADSESMODE_INT:
				tradSesMode = FixUtils.getTagIntValue(MsgTypes.TRADINGSESSIONSTATUSREQUEST ,id ,value );
			...
			case FixTags.SUBSCRIPTIONREQUESTTYPE_INT:
				subscriptionRequestType = FixUtils.getTagCharValue(MsgTypes.TRADINGSESSIONSTATUSREQUEST ,id ,value );
			...
			case FixTags.SECURITYEXCHANGE_INT:
				securityExchange = FixUtils.getTagStringValue(MsgTypes.TRADINGSESSIONSTATUSREQUEST ,id ,value, securityExchange);
				break;

			// for a message always get the checksum
			case FixTags.CHECKSUM_INT:
				checkSum = FixUtils.getTagIntValue( MsgTypes.TRADINGSESSIONSTATUSREQUEST ,FixTags.CHECKSUM_INT, value );
