...
public class FixStreamAssignmentReportACK extends FixMessage
{
	...
	public long streamAsgnAckType = 0;
	...
	public FixStreamAssignmentReportACK() {
		...
		msgType = MsgTypes.STREAMASSIGNMENTREPORTACK_INT;
	...
	public void clear()
	{
		...
		streamAsgnAckType = Long.MAX_VALUE;		
	...
	public void getAll() throws FixSessionException, FixGarbledException
	{
		...
		while ( ( id = FixUtils.getTagId( buf ) ) >= 0 )
		{
			...
			case FixTags.STREAMASGNACKTYPE_INT:
				streamAsgnAckType = FixUtils.getTagIntValue(MsgTypes.STREAMASSIGNMENTREPORTACK ,id ,value );
				if (!StreamAsgnAckType.isValid(streamAsgnAckType) ) throw new FixSessionException(SessionRejectReason.VALUE_IS_INCORRECT_OUT_OF_RANGE_FOR_THIS_TAG, ("Invalid enumerated value(" + streamAsgnAckType + ") for tag").getBytes(), id, FixUtils.getMsgType(msgType) );
				break;

			case FixTags.STREAMASGNRPTID_INT:
				streamAsgnRptID = FixUtils.getTagStringValue(MsgTypes.STREAMASSIGNMENTREPORTACK ,id ,value, streamAsgnRptID);
				break;

			case FixTags.STREAMASGNREJREASON_INT:
				streamAsgnRejReason = FixUtils.getTagIntValue(MsgTypes.STREAMASSIGNMENTREPORTACK ,id ,value );
				if (!StreamAsgnRejReason.isValid(streamAsgnRejReason) ) throw new FixSessionException(SessionRejectReason.VALUE_IS_INCORRECT_OUT_OF_RANGE_FOR_THIS_TAG, ("Invalid enumerated value(" + streamAsgnRejReason + ") for tag").getBytes(), id, FixUtils.getMsgType(msgType) );
				break;

			case FixTags.TEXT_INT:
				text = FixUtils.getTagStringValue(MsgTypes.STREAMASSIGNMENTREPORTACK ,id ,value, text);
				break;

			case FixTags.ENCODEDTEXTLEN_INT:
				encodedTextLen = FixUtils.getTagIntValue(MsgTypes.STREAMASSIGNMENTREPORTACK ,id ,value );
				break;

			case FixTags.ENCODEDTEXT_INT:
				encodedText = FixUtils.getTagStringValue(MsgTypes.STREAMASSIGNMENTREPORTACK ,id ,value, encodedText);
				break;

			// for a message always get the checksum
			case FixTags.CHECKSUM_INT:
				checkSum = FixUtils.getTagIntValue( MsgTypes.STREAMASSIGNMENTREPORTACK ,FixTags.CHECKSUM_INT, value );
	...
	public void encode( ByteBuffer out )
	{
		...
		FixUtils.putFixTag( out, FixTags.MSGTYPE_INT, MsgTypes.STREAMASSIGNMENTREPORTACK);
	...
	**/
	...
	public String toString() {
		...
		s += "MsgType(35)=" + new String(MsgTypes.STREAMASSIGNMENTREPORTACK) + sep;
	...
	public boolean equals(Object o) {
		...
		if (!( streamAsgnAckType==msg.streamAsgnAckType)) return false;

		if (!Utils.equals( streamAsgnRptID, msg.streamAsgnRptID)) return false;
