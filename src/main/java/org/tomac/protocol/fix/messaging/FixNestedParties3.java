...
public class FixNestedParties3 extends FixGroup {
	...
	long nested3PartyRole = 0;		
		FixNstdPtys3SubGrp[] nstdPtys3SubGrp;
	...
	public void encode(ByteBuffer out) {
		...
		for (FixNstdPtys3SubGrp fixNstdPtys3SubGrp : nstdPtys3SubGrp) fixNstdPtys3SubGrp.encode(out);
	}
	...
	public void setNested3PartyID(byte[] src) {		
		if (src == null ) return;
		if (hasNested3PartyID()) FixUtils.fillSpace(nested3PartyID);		
	...
	**/
	...
	public boolean equals(Object o) {
		...
		for (FixNstdPtys3SubGrp fixNstdPtys3SubGrp : nstdPtys3SubGrp)
			if (!fixNstdPtys3SubGrp.equals(msg.nstdPtys3SubGrp)) return false;
