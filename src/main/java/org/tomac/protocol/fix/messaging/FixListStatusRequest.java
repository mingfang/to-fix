...
public class FixListStatusRequest extends FixInMessage {
	...
	public FixListStatusRequest() {
		super(FixMessageInfo.MessageTypes.LISTSTATUSREQUEST);
            	...
            	default:
        			if ( standardHeader.isKeyTag(tag)) {
                		...
                		if (err.hasError()) break; 		
                			...
                			err.setError((int)FixMessageInfo.SessionRejectReason.TAG_NOT_DEFINED_FOR_THIS_MESSAGE_TYPE, "Tag not defined for this message type", tag, FixMessageInfo.MessageTypes.LISTSTATUSREQUEST_INT);
                			break;
                		}
					}
	...
	public boolean hasRequiredTags(FixValidationError err) {
		if (!hasListID()) { 
			err.setError((int)FixMessageInfo.SessionRejectReason.REQUIRED_TAG_MISSING, "Required tag missing", FixTags.LISTID_INT, FixMessageInfo.MessageTypes.LISTSTATUSREQUEST_INT);
			return false;
		}
		return true;
	}
	...
	**/
	...
	public boolean equals(Object o) {
		if (! ( o instanceof FixListStatusRequest)) return false;

		FixListStatusRequest msg = (FixListStatusRequest) o;
	...
	@Override
	public FixListStatusRequest clone () {
		FixListStatusRequest out = new FixListStatusRequest();
	...
	public FixListStatusRequest clone ( FixListStatusRequest out ) {
		if ( hasListID())
