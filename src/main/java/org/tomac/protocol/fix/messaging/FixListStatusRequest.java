...
public class FixListStatusRequest extends FixInMessage {
	...
	public boolean hasRequiredTags(FixValidationError err) {
		...
		if (!hasListID()) { 
			err.setError((int)FixMessageInfo.SessionRejectReason.REQUIRED_TAG_MISSING, "requirde tag ListID missing", FixTags.LISTID_INT, FixMessageInfo.MessageTypes.LISTSTATUSREQUEST);
			return false;
		}
