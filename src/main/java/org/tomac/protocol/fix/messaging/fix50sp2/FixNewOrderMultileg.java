...
public class FixNewOrderMultileg extends FixMessage
{
	...
	public FixNewOrderMultileg() {
		...
		msgType = MsgTypes.NEWORDERMULTILEG_INT;
	...
	public void getAll() throws FixSessionException, FixGarbledException
	{
		...
		while ( ( id = FixUtils.getTagId( buf ) ) >= 0 )
		{
			...
			case FixTags.CLORDID_INT:
				clOrdID = FixUtils.getTagStringValue(MsgTypes.NEWORDERMULTILEG ,id ,value, clOrdID);
				break;

			case FixTags.SECONDARYCLORDID_INT:
				secondaryClOrdID = FixUtils.getTagStringValue(MsgTypes.NEWORDERMULTILEG ,id ,value, secondaryClOrdID);
				break;

			case FixTags.CLORDLINKID_INT:
				clOrdLinkID = FixUtils.getTagStringValue(MsgTypes.NEWORDERMULTILEG ,id ,value, clOrdLinkID);
				break;

			case FixTags.NOPARTYIDS_INT:
				parties.noPartyIDs = FixUtils.getTagIntValue( MsgTypes.NEWORDERMULTILEG ,FixTags.NOPARTYIDS_INT ,value );
				parties.getAll(parties.noPartyIDs, value );
				break;

			case FixTags.TRADEORIGINATIONDATE_INT:
				tradeOriginationDate = FixUtils.getTagStringValue(MsgTypes.NEWORDERMULTILEG ,id ,value, tradeOriginationDate);
				break;

			case FixTags.TRADEDATE_INT:
				tradeDate = FixUtils.getTagStringValue(MsgTypes.NEWORDERMULTILEG ,id ,value, tradeDate);
				break;

			case FixTags.ACCOUNT_INT:
				account = FixUtils.getTagStringValue(MsgTypes.NEWORDERMULTILEG ,id ,value, account);
				break;

			case FixTags.ACCTIDSOURCE_INT:
				acctIDSource = FixUtils.getTagIntValue(MsgTypes.NEWORDERMULTILEG ,id ,value );
			...
			case FixTags.ACCOUNTTYPE_INT:
				accountType = FixUtils.getTagIntValue(MsgTypes.NEWORDERMULTILEG ,id ,value );
			...
			case FixTags.DAYBOOKINGINST_INT:
				dayBookingInst = FixUtils.getTagCharValue(MsgTypes.NEWORDERMULTILEG ,id ,value );
			...
			case FixTags.BOOKINGUNIT_INT:
				bookingUnit = FixUtils.getTagCharValue(MsgTypes.NEWORDERMULTILEG ,id ,value );
			...
			case FixTags.PREALLOCMETHOD_INT:
				preallocMethod = FixUtils.getTagCharValue(MsgTypes.NEWORDERMULTILEG ,id ,value );
			...
			case FixTags.ALLOCID_INT:
				allocID = FixUtils.getTagStringValue(MsgTypes.NEWORDERMULTILEG ,id ,value, allocID);
				break;

			case FixTags.NOALLOCS_INT:
				preAllocMlegGrp.noAllocs = FixUtils.getTagIntValue( MsgTypes.NEWORDERMULTILEG ,FixTags.NOALLOCS_INT ,value );
				preAllocMlegGrp.getAll(preAllocMlegGrp.noAllocs, value );
				break;

			case FixTags.SETTLTYPE_INT:
				settlType = FixUtils.getTagStringValue(MsgTypes.NEWORDERMULTILEG ,id ,value, settlType);
			...
			case FixTags.SETTLDATE_INT:
				settlDate = FixUtils.getTagStringValue(MsgTypes.NEWORDERMULTILEG ,id ,value, settlDate);
				break;

			case FixTags.CASHMARGIN_INT:
				cashMargin = FixUtils.getTagCharValue(MsgTypes.NEWORDERMULTILEG ,id ,value );
			...
			case FixTags.CLEARINGFEEINDICATOR_INT:
				clearingFeeIndicator = FixUtils.getTagStringValue(MsgTypes.NEWORDERMULTILEG ,id ,value, clearingFeeIndicator);
			...
			case FixTags.HANDLINST_INT:
				handlInst = FixUtils.getTagCharValue(MsgTypes.NEWORDERMULTILEG ,id ,value );
			...
			case FixTags.EXECINST_INT:
				execInst = FixUtils.getTagStringValue(MsgTypes.NEWORDERMULTILEG ,id ,value, execInst);
			...
			case FixTags.MINQTY_INT:
				minQty = FixUtils.getTagFloatValue(MsgTypes.NEWORDERMULTILEG ,id ,value);
				break;

			case FixTags.MATCHINCREMENT_INT:
				matchIncrement = FixUtils.getTagFloatValue(MsgTypes.NEWORDERMULTILEG ,id ,value);
				break;

			case FixTags.MAXPRICELEVELS_INT:
				maxPriceLevels = FixUtils.getTagIntValue(MsgTypes.NEWORDERMULTILEG ,id ,value );
				break;
			...
			case FixTags.MAXFLOOR_INT:
				maxFloor = FixUtils.getTagFloatValue(MsgTypes.NEWORDERMULTILEG ,id ,value);
				break;

			case FixTags.EXDESTINATION_INT:
				exDestination = FixUtils.getTagStringValue(MsgTypes.NEWORDERMULTILEG ,id ,value, exDestination);
				break;

			case FixTags.EXDESTINATIONIDSOURCE_INT:
				exDestinationIDSource = FixUtils.getTagCharValue(MsgTypes.NEWORDERMULTILEG ,id ,value );
			...
			case FixTags.NOTRADINGSESSIONS_INT:
				trdgSesGrp.noTradingSessions = FixUtils.getTagIntValue( MsgTypes.NEWORDERMULTILEG ,FixTags.NOTRADINGSESSIONS_INT ,value );
				trdgSesGrp.getAll(trdgSesGrp.noTradingSessions, value );
				break;

			case FixTags.PROCESSCODE_INT:
				processCode = FixUtils.getTagCharValue(MsgTypes.NEWORDERMULTILEG ,id ,value );
			...
			case FixTags.SIDE_INT:
				side = FixUtils.getTagCharValue(MsgTypes.NEWORDERMULTILEG ,id ,value );
			...
			case FixTags.NOUNDERLYINGS_INT:
				undInstrmtGrp.noUnderlyings = FixUtils.getTagIntValue( MsgTypes.NEWORDERMULTILEG ,FixTags.NOUNDERLYINGS_INT ,value );
				undInstrmtGrp.getAll(undInstrmtGrp.noUnderlyings, value );
				break;

			case FixTags.PREVCLOSEPX_INT:
				prevClosePx = FixUtils.getTagFloatValue(MsgTypes.NEWORDERMULTILEG ,id ,value);
				break;

			case FixTags.SWAPPOINTS_INT:
				swapPoints = FixUtils.getTagFloatValue(MsgTypes.NEWORDERMULTILEG ,id ,value);
				break;

			case FixTags.NOLEGS_INT:
				legOrdGrp.noLegs = FixUtils.getTagIntValue( MsgTypes.NEWORDERMULTILEG ,FixTags.NOLEGS_INT ,value );
				legOrdGrp.getAll(legOrdGrp.noLegs, value );
				break;

			case FixTags.LOCATEREQD_INT:
				locateReqd = FixUtils.getTagBooleanValue(MsgTypes.NEWORDERMULTILEG ,id ,value );
			...
			case FixTags.TRANSACTTIME_INT:
				transactTime = FixUtils.getTagStringValue(MsgTypes.NEWORDERMULTILEG ,id ,value, transactTime);
				break;

			case FixTags.QTYTYPE_INT:
				qtyType = FixUtils.getTagIntValue(MsgTypes.NEWORDERMULTILEG ,id ,value );
			...
			case FixTags.ORDTYPE_INT:
				ordType = FixUtils.getTagCharValue(MsgTypes.NEWORDERMULTILEG ,id ,value );
			...
			case FixTags.MULTILEGMODEL_INT:
				multilegModel = FixUtils.getTagIntValue(MsgTypes.NEWORDERMULTILEG ,id ,value );
			...
			case FixTags.MULTILEGPRICEMETHOD_INT:
				multilegPriceMethod = FixUtils.getTagIntValue(MsgTypes.NEWORDERMULTILEG ,id ,value );
			...
			case FixTags.PRICETYPE_INT:
				priceType = FixUtils.getTagIntValue(MsgTypes.NEWORDERMULTILEG ,id ,value );
			...
			case FixTags.PRICE_INT:
				price = FixUtils.getTagFloatValue(MsgTypes.NEWORDERMULTILEG ,id ,value);
				break;

			case FixTags.PRICEPROTECTIONSCOPE_INT:
				priceProtectionScope = FixUtils.getTagCharValue(MsgTypes.NEWORDERMULTILEG ,id ,value );
			...
			case FixTags.STOPPX_INT:
				stopPx = FixUtils.getTagFloatValue(MsgTypes.NEWORDERMULTILEG ,id ,value);
				break;
			...
			case FixTags.CURRENCY_INT:
				currency = FixUtils.getTagStringValue(MsgTypes.NEWORDERMULTILEG ,id ,value, currency);
				break;

			case FixTags.COMPLIANCEID_INT:
				complianceID = FixUtils.getTagStringValue(MsgTypes.NEWORDERMULTILEG ,id ,value, complianceID);
				break;

			case FixTags.SOLICITEDFLAG_INT:
				solicitedFlag = FixUtils.getTagBooleanValue(MsgTypes.NEWORDERMULTILEG ,id ,value );
			...
			case FixTags.IOIID_INT:
				iOIID = FixUtils.getTagStringValue(MsgTypes.NEWORDERMULTILEG ,id ,value, iOIID);
				break;

			case FixTags.QUOTEID_INT:
				quoteID = FixUtils.getTagStringValue(MsgTypes.NEWORDERMULTILEG ,id ,value, quoteID);
				break;

			case FixTags.REFORDERID_INT:
				refOrderID = FixUtils.getTagStringValue(MsgTypes.NEWORDERMULTILEG ,id ,value, refOrderID);
				break;

			case FixTags.REFORDERIDSOURCE_INT:
				refOrderIDSource = FixUtils.getTagCharValue(MsgTypes.NEWORDERMULTILEG ,id ,value );
			...
			case FixTags.TIMEINFORCE_INT:
				timeInForce = FixUtils.getTagCharValue(MsgTypes.NEWORDERMULTILEG ,id ,value );
			...
			case FixTags.EFFECTIVETIME_INT:
				effectiveTime = FixUtils.getTagStringValue(MsgTypes.NEWORDERMULTILEG ,id ,value, effectiveTime);
				break;

			case FixTags.EXPIREDATE_INT:
				expireDate = FixUtils.getTagStringValue(MsgTypes.NEWORDERMULTILEG ,id ,value, expireDate);
				break;

			case FixTags.EXPIRETIME_INT:
				expireTime = FixUtils.getTagStringValue(MsgTypes.NEWORDERMULTILEG ,id ,value, expireTime);
				break;

			case FixTags.GTBOOKINGINST_INT:
				gTBookingInst = FixUtils.getTagIntValue(MsgTypes.NEWORDERMULTILEG ,id ,value );
			...
			case FixTags.ORDERCAPACITY_INT:
				orderCapacity = FixUtils.getTagCharValue(MsgTypes.NEWORDERMULTILEG ,id ,value );
			...
			case FixTags.ORDERRESTRICTIONS_INT:
				orderRestrictions = FixUtils.getTagStringValue(MsgTypes.NEWORDERMULTILEG ,id ,value, orderRestrictions);
			...
			case FixTags.PRETRADEANONYMITY_INT:
				preTradeAnonymity = FixUtils.getTagBooleanValue(MsgTypes.NEWORDERMULTILEG ,id ,value );
				break;

			case FixTags.CUSTORDERCAPACITY_INT:
				custOrderCapacity = FixUtils.getTagIntValue(MsgTypes.NEWORDERMULTILEG ,id ,value );
			...
			case FixTags.FOREXREQ_INT:
				forexReq = FixUtils.getTagBooleanValue(MsgTypes.NEWORDERMULTILEG ,id ,value );
			...
			case FixTags.SETTLCURRENCY_INT:
				settlCurrency = FixUtils.getTagStringValue(MsgTypes.NEWORDERMULTILEG ,id ,value, settlCurrency);
				break;

			case FixTags.BOOKINGTYPE_INT:
				bookingType = FixUtils.getTagIntValue(MsgTypes.NEWORDERMULTILEG ,id ,value );
			...
			case FixTags.TEXT_INT:
				text = FixUtils.getTagStringValue(MsgTypes.NEWORDERMULTILEG ,id ,value, text);
				break;

			case FixTags.ENCODEDTEXTLEN_INT:
				encodedTextLen = FixUtils.getTagIntValue(MsgTypes.NEWORDERMULTILEG ,id ,value );
				break;

			case FixTags.ENCODEDTEXT_INT:
				encodedText = FixUtils.getTagStringValue(MsgTypes.NEWORDERMULTILEG ,id ,value, encodedText);
				break;

			case FixTags.POSITIONEFFECT_INT:
				positionEffect = FixUtils.getTagCharValue(MsgTypes.NEWORDERMULTILEG ,id ,value );
			...
			case FixTags.COVEREDORUNCOVERED_INT:
				coveredOrUncovered = FixUtils.getTagIntValue(MsgTypes.NEWORDERMULTILEG ,id ,value );
			...
			case FixTags.MAXSHOW_INT:
				maxShow = FixUtils.getTagFloatValue(MsgTypes.NEWORDERMULTILEG ,id ,value);
				break;
			...
			case FixTags.TARGETSTRATEGY_INT:
				targetStrategy = FixUtils.getTagIntValue(MsgTypes.NEWORDERMULTILEG ,id ,value );
			...
			case FixTags.NOSTRATEGYPARAMETERS_INT:
				strategyParametersGrp.noStrategyParameters = FixUtils.getTagIntValue( MsgTypes.NEWORDERMULTILEG ,FixTags.NOSTRATEGYPARAMETERS_INT ,value );
				strategyParametersGrp.getAll(strategyParametersGrp.noStrategyParameters, value );
				break;

			case FixTags.TARGETSTRATEGYPARAMETERS_INT:
				targetStrategyParameters = FixUtils.getTagStringValue(MsgTypes.NEWORDERMULTILEG ,id ,value, targetStrategyParameters);
				break;

			case FixTags.RISKFREERATE_INT:
				riskFreeRate = FixUtils.getTagFloatValue(MsgTypes.NEWORDERMULTILEG ,id ,value);
				break;

			case FixTags.PARTICIPATIONRATE_INT:
				participationRate = FixUtils.getTagFloatValue(MsgTypes.NEWORDERMULTILEG ,id ,value);
				break;

			case FixTags.CANCELLATIONRIGHTS_INT:
				cancellationRights = FixUtils.getTagCharValue(MsgTypes.NEWORDERMULTILEG ,id ,value );
			...
			case FixTags.MONEYLAUNDERINGSTATUS_INT:
				moneyLaunderingStatus = FixUtils.getTagCharValue(MsgTypes.NEWORDERMULTILEG ,id ,value );
			...
			case FixTags.REGISTID_INT:
				registID = FixUtils.getTagStringValue(MsgTypes.NEWORDERMULTILEG ,id ,value, registID);
				break;

			case FixTags.DESIGNATION_INT:
				designation = FixUtils.getTagStringValue(MsgTypes.NEWORDERMULTILEG ,id ,value, designation);
				break;

			case FixTags.MULTILEGRPTTYPEREQ_INT:
				multiLegRptTypeReq = FixUtils.getTagIntValue(MsgTypes.NEWORDERMULTILEG ,id ,value );
			...
			case FixTags.CHECKSUM_INT:
				checkSum = FixUtils.getTagIntValue( MsgTypes.NEWORDERMULTILEG ,FixTags.CHECKSUM_INT, value );
	...
	public void encode( ByteBuffer out )
	{
		...
		FixUtils.putFixTag( out, FixTags.MSGTYPE_INT, MsgTypes.NEWORDERMULTILEG);
	...
	**/
	...
	public String toString() {
		...
		s += "MsgType(35)=" + new String(MsgTypes.NEWORDERMULTILEG) + sep;
