	...
	public void getAll() throws FixSessionException, FixGarbledException
	{
		...
		while ( ( id = FixUtils.getTagId( buf ) ) >= 0 )
		{
			...
			case FixTags.APPLRESPONSEID_INT:
				applResponseID = FixUtils.getTagStringValue(MsgTypes.APPLICATIONMESSAGEREQUESTACK ,id ,value, applResponseID);
				break;

			case FixTags.APPLREQID_INT:
				applReqID = FixUtils.getTagStringValue(MsgTypes.APPLICATIONMESSAGEREQUESTACK ,id ,value, applReqID);
				break;

			case FixTags.APPLREQTYPE_INT:
				applReqType = FixUtils.getTagIntValue(MsgTypes.APPLICATIONMESSAGEREQUESTACK ,id ,value );
			...
			case FixTags.APPLRESPONSETYPE_INT:
				applResponseType = FixUtils.getTagIntValue(MsgTypes.APPLICATIONMESSAGEREQUESTACK ,id ,value );
			...
			case FixTags.APPLTOTALMESSAGECOUNT_INT:
				applTotalMessageCount = FixUtils.getTagIntValue(MsgTypes.APPLICATIONMESSAGEREQUESTACK ,id ,value );
				break;

			case FixTags.NOAPPLIDS_INT:
				applIDRequestAckGrp.noApplIDs = FixUtils.getTagIntValue( MsgTypes.APPLICATIONMESSAGEREQUESTACK ,FixTags.NOAPPLIDS_INT ,value );
				applIDRequestAckGrp.getAll(applIDRequestAckGrp.noApplIDs, value );
				break;

			case FixTags.NOPARTYIDS_INT:
				parties.noPartyIDs = FixUtils.getTagIntValue( MsgTypes.APPLICATIONMESSAGEREQUESTACK ,FixTags.NOPARTYIDS_INT ,value );
				parties.getAll(parties.noPartyIDs, value );
				break;

			case FixTags.TEXT_INT:
				text = FixUtils.getTagStringValue(MsgTypes.APPLICATIONMESSAGEREQUESTACK ,id ,value, text);
				break;

			case FixTags.ENCODEDTEXTLEN_INT:
				encodedTextLen = FixUtils.getTagIntValue(MsgTypes.APPLICATIONMESSAGEREQUESTACK ,id ,value );
				break;

			case FixTags.ENCODEDTEXT_INT:
				encodedText = FixUtils.getTagStringValue(MsgTypes.APPLICATIONMESSAGEREQUESTACK ,id ,value, encodedText);
				break;

			// for a message always get the checksum
			case FixTags.CHECKSUM_INT:
				checkSum = FixUtils.getTagIntValue( MsgTypes.APPLICATIONMESSAGEREQUESTACK ,FixTags.CHECKSUM_INT, value );
