...
public class FixSettlementInstructions extends FixMessage
{
	...
	public byte[] settlInstMsgID;
	public byte[] settlInstReqID;
	public byte settlInstMode = (byte)' ';
	public long settlInstReqRejCode = 0;
	public byte[] text;
	...
	public void clear()
	{
		...
		Utils.fill( settlInstMsgID, (byte)0 );
		Utils.fill( settlInstReqID, (byte)0 );
		settlInstMode = Byte.MAX_VALUE;		
		settlInstReqRejCode = Long.MAX_VALUE;		
	...
	public void encode( ByteBuffer out )
	{
		...
		FixUtils.putFixTag( out, FixTags.MSGTYPE_INT, MsgTypes.SETTLEMENTINSTRUCTIONS);
		...
		FixUtils.putFixTag( out, FixTags.SETTLINSTMODE_INT, settlInstMode );
		if (FixUtils.isSet(settlInstReqRejCode)) FixUtils.putFixTag( out, FixTags.SETTLINSTREQREJCODE_INT, settlInstReqRejCode);
	...
	**/
	...
	public String toString() {
		...
		s += "MsgType(35)=" + new String(MsgTypes.SETTLEMENTINSTRUCTIONS) + sep;
		...
		try {
			...
			if (FixUtils.isSet(settlInstReqID)) s += "SettlInstReqID(791)=" + new String(settlInstReqID) + sep;
			 s += "SettlInstMode(160)=" + String.valueOf(settlInstMode) + sep;
			if (FixUtils.isSet(settlInstReqRejCode)) s += "SettlInstReqRejCode(792)=" + String.valueOf(settlInstReqRejCode) + sep;
	...
	public boolean equals(Object o) {
		...
		if (!Utils.equals( settlInstMsgID, msg.settlInstMsgID)) return false;

		if (!Utils.equals( settlInstReqID, msg.settlInstReqID)) return false;

		if (!( settlInstMode==msg.settlInstMode)) return false;

		if (!( settlInstReqRejCode==msg.settlInstReqRejCode)) return false;
