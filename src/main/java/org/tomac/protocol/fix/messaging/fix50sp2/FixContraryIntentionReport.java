...
public class FixContraryIntentionReport extends FixMessage
{
	...
	public FixContraryIntentionReport() {
		...
		msgType = MsgTypes.CONTRARYINTENTIONREPORT_INT;
	...
	public void clear()
	{
		...
		Utils.fill( contIntRptID, (byte)0 );
		Utils.fill( transactTime, (byte)0 );
		lateIndicator = false;		
		Utils.fill( inputSource, (byte)0 );
	...
	public void encode( ByteBuffer out )
	{
		...
		FixUtils.putFixTag( out, FixTags.MSGTYPE_INT, MsgTypes.CONTRARYINTENTIONREPORT);
	...
	**/
	...
	public String toString() {
		...
		s += "MsgType(35)=" + new String(MsgTypes.CONTRARYINTENTIONREPORT) + sep;
	...
	public boolean equals(Object o) {
		...
		if (!Utils.equals( contIntRptID, msg.contIntRptID)) return false;
