...
public class FixNetworkCounterpartySystemStatusRequest extends FixMessage
{
	...
	public void encode( ByteBuffer out )
	{
		...
		FixUtils.putFixTag( out, FixTags.MSGTYPE_INT, MsgTypes.NETWORKCOUNTERPARTYSYSTEMSTATUSREQUEST);
	...
	**/
	...
	public String toString() {
		...
		s += "MsgType(35)=" + new String(MsgTypes.NETWORKCOUNTERPARTYSYSTEMSTATUSREQUEST) + sep;
