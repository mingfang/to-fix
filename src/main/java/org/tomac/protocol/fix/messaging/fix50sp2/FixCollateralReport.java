...
public class FixCollateralReport extends FixMessage
{

	public byte[] collRptID;
	public byte[] collInquiryID;
	public byte[] transactTime;
	public long collApplType = 0;
	public byte[] financialStatus;
	public long collStatus = 0;
	...
	public FixCollateralReport() {
		...
		msgType = MsgTypes.COLLATERALREPORT_INT;
	...
	public void getAll() throws FixSessionException, IllegalStateException
	{
		...
		while ( ( id = FixUtils.getTagId( buf ) ) > 0 )
		{
			...
			case FixTags.COLLSTATUS_INT:
				...
				if (!CollStatus.isValid(collStatus) ) throw new FixSessionException(buf, "Invalid enumerated value(" + collStatus + ") for tag: " + id );
				break;
	...
	private int checkRequiredTags() {
		...
		if (! FixUtils.isSet(collRptID) ) return FixTags.COLLRPTID_INT;
		if (! FixUtils.isSet(collStatus) ) return FixTags.COLLSTATUS_INT;
		return tag;
	...
	public void encode( ByteBuffer out )
	{
		...
		FixUtils.putFixTag( out, FixTags.MSGTYPE_INT, MsgTypes.COLLATERALREPORT);
		...
		FixUtils.putFixTag( out, FixTags.COLLRPTID_INT, collRptID, 0, Utils.lastIndexTrim(collRptID, (byte)0) );
		if (FixUtils.isSet(collInquiryID)) FixUtils.putFixTag( out, FixTags.COLLINQUIRYID_INT, collInquiryID, 0, Utils.lastIndexTrim(collInquiryID, (byte)0) );
		...
		FixUtils.putFixTag( out, FixTags.COLLSTATUS_INT, collStatus);
	...
	**/
	...
	public String toString() {
		...
		s += "MsgType(35)=" + new String(MsgTypes.COLLATERALREPORT) + sep;
		...
		try {
			...
			if (FixUtils.isSet(lastMsgSeqNumProcessed)) s += "LastMsgSeqNumProcessed(369)=" + String.valueOf(lastMsgSeqNumProcessed) + sep;
			 ...
			 s += "CollRptID(908)=" + new String(collRptID) + sep;
			if (FixUtils.isSet(collInquiryID)) s += "CollInquiryID(909)=" + new String(collInquiryID) + sep;
			...
			if (FixUtils.isSet(financialStatus)) s += "FinancialStatus(291)=" + new String(financialStatus) + sep;
			 s += "CollStatus(910)=" + String.valueOf(collStatus) + sep;
	...
	public boolean equals(Object o) {
		...
		if (!Utils.equals( collRptID, msg.collRptID)) return false;
		...
		if (!( collStatus==msg.collStatus)) return false;
