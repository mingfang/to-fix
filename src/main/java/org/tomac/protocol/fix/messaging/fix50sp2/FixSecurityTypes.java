...
public class FixSecurityTypes extends FixMessage
{
	...
	public FixSecurityTypes() {
		...
		msgType = MsgTypes.SECURITYTYPES_INT;
	...
	public void clear()
	{
		...
		totNoSecurityTypes = Long.MAX_VALUE;		
		lastFragment = false;		
	...
	public void getAll() throws FixSessionException, FixGarbledException
	{
		...
		while ( ( id = FixUtils.getTagId( buf ) ) >= 0 )
		{
			...
			case FixTags.SECURITYREQID_INT:
				securityReqID = FixUtils.getTagStringValue(MsgTypes.SECURITYTYPES ,id ,value, securityReqID);
				break;

			case FixTags.SECURITYRESPONSEID_INT:
				securityResponseID = FixUtils.getTagStringValue(MsgTypes.SECURITYTYPES ,id ,value, securityResponseID);
				break;

			case FixTags.SECURITYRESPONSETYPE_INT:
				securityResponseType = FixUtils.getTagIntValue(MsgTypes.SECURITYTYPES ,id ,value );
			...
			case FixTags.TOTNOSECURITYTYPES_INT:
				totNoSecurityTypes = FixUtils.getTagIntValue(MsgTypes.SECURITYTYPES ,id ,value );
				break;

			case FixTags.LASTFRAGMENT_INT:
				lastFragment = FixUtils.getTagBooleanValue(MsgTypes.SECURITYTYPES ,id ,value );
			...
			case FixTags.NOSECURITYTYPES_INT:
				secTypesGrp.noSecurityTypes = FixUtils.getTagIntValue( MsgTypes.SECURITYTYPES ,FixTags.NOSECURITYTYPES_INT ,value );
				secTypesGrp.getAll(secTypesGrp.noSecurityTypes, value );
				break;

			case FixTags.TEXT_INT:
				text = FixUtils.getTagStringValue(MsgTypes.SECURITYTYPES ,id ,value, text);
				break;

			case FixTags.ENCODEDTEXTLEN_INT:
				encodedTextLen = FixUtils.getTagIntValue(MsgTypes.SECURITYTYPES ,id ,value );
				break;

			case FixTags.ENCODEDTEXT_INT:
				encodedText = FixUtils.getTagStringValue(MsgTypes.SECURITYTYPES ,id ,value, encodedText);
				break;

			case FixTags.MARKETID_INT:
				marketID = FixUtils.getTagStringValue(MsgTypes.SECURITYTYPES ,id ,value, marketID);
				break;

			case FixTags.MARKETSEGMENTID_INT:
				marketSegmentID = FixUtils.getTagStringValue(MsgTypes.SECURITYTYPES ,id ,value, marketSegmentID);
				break;

			case FixTags.TRADINGSESSIONID_INT:
				tradingSessionID = FixUtils.getTagStringValue(MsgTypes.SECURITYTYPES ,id ,value, tradingSessionID);
			...
			case FixTags.TRADINGSESSIONSUBID_INT:
				tradingSessionSubID = FixUtils.getTagStringValue(MsgTypes.SECURITYTYPES ,id ,value, tradingSessionSubID);
			...
			case FixTags.SUBSCRIPTIONREQUESTTYPE_INT:
				subscriptionRequestType = FixUtils.getTagCharValue(MsgTypes.SECURITYTYPES ,id ,value );
			...
			case FixTags.CHECKSUM_INT:
				checkSum = FixUtils.getTagIntValue( MsgTypes.SECURITYTYPES ,FixTags.CHECKSUM_INT, value );
	...
	public void encode( ByteBuffer out )
	{
		...
		FixUtils.putFixTag( out, FixTags.MSGTYPE_INT, MsgTypes.SECURITYTYPES);
	...
	**/
	...
	public String toString() {
		...
		s += "MsgType(35)=" + new String(MsgTypes.SECURITYTYPES) + sep;
