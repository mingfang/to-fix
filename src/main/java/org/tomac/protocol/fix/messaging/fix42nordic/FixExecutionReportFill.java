...
public class FixExecutionReportFill extends FixMessage
{
	...
	public byte liquidityFlag = (byte)' ';
	...
	public FixExecutionReportFill() {
		...
		msgType = MsgTypes.EXECUTIONREPORTFILL_INT;
	...
	public void getAll() throws FixSessionException, FixGarbledException
	{
		...
		while ( ( id = FixUtils.getTagId( buf ) ) >= 0 )
		{
			...
			case FixTags.AVGPX_INT:
				avgPx = FixUtils.getTagFloatValue(MsgTypes.EXECUTIONREPORTFILL ,id ,value);
				break;

			case FixTags.CLORDID_INT:
				clOrdID = FixUtils.getTagStringValue(MsgTypes.EXECUTIONREPORTFILL ,id ,value, clOrdID);
				break;

			case FixTags.CUMQTY_INT:
				cumQty = FixUtils.getTagFloatValue(MsgTypes.EXECUTIONREPORTFILL ,id ,value);
				break;

			case FixTags.CURRENCY_INT:
				currency = FixUtils.getTagStringValue(MsgTypes.EXECUTIONREPORTFILL ,id ,value, currency);
				break;

			case FixTags.EXECID_INT:
				execID = FixUtils.getTagStringValue(MsgTypes.EXECUTIONREPORTFILL ,id ,value, execID);
				break;

			case FixTags.EXECINST_INT:
				execInst = FixUtils.getTagStringValue(MsgTypes.EXECUTIONREPORTFILL ,id ,value, execInst);
			...
			case FixTags.EXECTRANSTYPE_INT:
				execTransType = FixUtils.getTagCharValue(MsgTypes.EXECUTIONREPORTFILL ,id ,value );
			...
			case FixTags.LASTPX_INT:
				lastPx = FixUtils.getTagFloatValue(MsgTypes.EXECUTIONREPORTFILL ,id ,value);
				break;

			case FixTags.LASTSHARES_INT:
				lastShares = FixUtils.getTagFloatValue(MsgTypes.EXECUTIONREPORTFILL ,id ,value);
				break;

			case FixTags.ORDERID_INT:
				orderID = FixUtils.getTagStringValue(MsgTypes.EXECUTIONREPORTFILL ,id ,value, orderID);
				break;

			case FixTags.ORDERQTY_INT:
				orderQty = FixUtils.getTagFloatValue(MsgTypes.EXECUTIONREPORTFILL ,id ,value);
				break;

			case FixTags.ORDSTATUS_INT:
				ordStatus = FixUtils.getTagCharValue(MsgTypes.EXECUTIONREPORTFILL ,id ,value );
			...
			case FixTags.ORDTYPE_INT:
				ordType = FixUtils.getTagCharValue(MsgTypes.EXECUTIONREPORTFILL ,id ,value );
			...
			case FixTags.ORIGCLORDID_INT:
				origClOrdID = FixUtils.getTagStringValue(MsgTypes.EXECUTIONREPORTFILL ,id ,value, origClOrdID);
				break;

			case FixTags.PRICE_INT:
				price = FixUtils.getTagFloatValue(MsgTypes.EXECUTIONREPORTFILL ,id ,value);
				break;

			case FixTags.SECURITYID_INT:
				securityID = FixUtils.getTagStringValue(MsgTypes.EXECUTIONREPORTFILL ,id ,value, securityID);
				break;

			case FixTags.SIDE_INT:
				side = FixUtils.getTagCharValue(MsgTypes.EXECUTIONREPORTFILL ,id ,value );
			...
			case FixTags.SYMBOL_INT:
				symbol = FixUtils.getTagStringValue(MsgTypes.EXECUTIONREPORTFILL ,id ,value, symbol);
				break;

			case FixTags.TEXT_INT:
				text = FixUtils.getTagStringValue(MsgTypes.EXECUTIONREPORTFILL ,id ,value, text);
				break;

			case FixTags.TIMEINFORCE_INT:
				timeInForce = FixUtils.getTagCharValue(MsgTypes.EXECUTIONREPORTFILL ,id ,value );
			...
			case FixTags.TRANSACTTIME_INT:
				transactTime = FixUtils.getTagStringValue(MsgTypes.EXECUTIONREPORTFILL ,id ,value, transactTime);
				break;

			case FixTags.TRADEDATE_INT:
				tradeDate = FixUtils.getTagStringValue(MsgTypes.EXECUTIONREPORTFILL ,id ,value, tradeDate);
				break;

			case FixTags.CLIENTID_INT:
				clientID = FixUtils.getTagStringValue(MsgTypes.EXECUTIONREPORTFILL ,id ,value, clientID);
				break;

			case FixTags.MINQTY_INT:
				minQty = FixUtils.getTagFloatValue(MsgTypes.EXECUTIONREPORTFILL ,id ,value);
				break;

			case FixTags.MAXFLOOR_INT:
				maxFloor = FixUtils.getTagFloatValue(MsgTypes.EXECUTIONREPORTFILL ,id ,value);
				break;

			case FixTags.EXECTYPE_INT:
				execType = FixUtils.getTagCharValue(MsgTypes.EXECUTIONREPORTFILL ,id ,value );
			...
			case FixTags.LEAVESQTY_INT:
				leavesQty = FixUtils.getTagFloatValue(MsgTypes.EXECUTIONREPORTFILL ,id ,value);
				break;

			case FixTags.NOCONTRABROKERS_INT:
				noContraBrokers = FixUtils.getTagIntValue(MsgTypes.EXECUTIONREPORTFILL ,id ,value );
				break;

			case FixTags.CONTRABROKER_INT:
				contraBroker = FixUtils.getTagStringValue(MsgTypes.EXECUTIONREPORTFILL ,id ,value, contraBroker);
				break;

			case FixTags.CLEARINGFIRM_INT:
				clearingFirm = FixUtils.getTagStringValue(MsgTypes.EXECUTIONREPORTFILL ,id ,value, clearingFirm);
				break;

			case FixTags.CLEARINGACCOUNT_INT:
				clearingAccount = FixUtils.getTagStringValue(MsgTypes.EXECUTIONREPORTFILL ,id ,value, clearingAccount);
				break;

			case FixTags.ORDERCAPACITY_INT:
				orderCapacity = FixUtils.getTagStringValue(MsgTypes.EXECUTIONREPORTFILL ,id ,value, orderCapacity);
			...
			case FixTags.ORDERRESTRICTIONS_INT:
				orderRestrictions = FixUtils.getTagStringValue(MsgTypes.EXECUTIONREPORTFILL ,id ,value, orderRestrictions);
			...
			case FixTags.TRADEID_INT:
				tradeID = FixUtils.getTagStringValue(MsgTypes.EXECUTIONREPORTFILL ,id ,value, tradeID);
				break;

			case FixTags.SUBMKTID_INT:
				subMktID = FixUtils.getTagStringValue(MsgTypes.EXECUTIONREPORTFILL ,id ,value, subMktID);
				break;

			case FixTags.CLREFID_INT:
				clRefID = FixUtils.getTagStringValue(MsgTypes.EXECUTIONREPORTFILL ,id ,value, clRefID);
				break;

			case FixTags.DISPLAYINST_INT:
				displayInst = FixUtils.getTagCharValue(MsgTypes.EXECUTIONREPORTFILL ,id ,value );
			...
			case FixTags.BRSEQNBR_INT:
				brSeqNbr = FixUtils.getTagStringValue(MsgTypes.EXECUTIONREPORTFILL ,id ,value, brSeqNbr);
				break;

			case FixTags.LIQUIDITYFLAG_INT:
				liquidityFlag = FixUtils.getTagCharValue(MsgTypes.EXECUTIONREPORTFILL ,id ,value );
				if (!LiquidityFlag.isValid(liquidityFlag) ) throw new FixSessionException(SessionRejectReason.VALUE_IS_INCORRECT_OUT_OF_RANGE_FOR_THIS_TAG, ("Invalid enumerated value(" + liquidityFlag + ") for tag").getBytes(), id, FixUtils.getMsgType(msgType) );
				break;

			// for a message always get the checksum
			case FixTags.CHECKSUM_INT:
				checkSum = FixUtils.getTagIntValue( MsgTypes.EXECUTIONREPORTFILL ,FixTags.CHECKSUM_INT, value );
	...
	private int checkRequiredTags() {
		...
		if (! FixUtils.isSet(liquidityFlag) ) return FixTags.LIQUIDITYFLAG_INT;
	...
	public void encode( ByteBuffer out )
	{
		...
		FixUtils.putFixTag( out, FixTags.MSGTYPE_INT, MsgTypes.EXECUTIONREPORTFILL);
		...
		FixUtils.putFixTag( out, FixTags.LIQUIDITYFLAG_INT, liquidityFlag );
	...
	**/
	...
	public String toString() {
		...
		s += "MsgType(35)=" + new String(MsgTypes.EXECUTIONREPORTFILL) + sep;
		...
		try {
			...
			if (FixUtils.isSet(brSeqNbr)) s += "BrSeqNbr(9861)=" + new String(brSeqNbr) + sep;
			 s += "LiquidityFlag(9882)=" + String.valueOf(liquidityFlag) + sep;
	...
	public boolean equals(Object o) {
		...
		if (!( liquidityFlag==msg.liquidityFlag)) return false;
