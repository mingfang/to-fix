...
public class FixSecListGrp extends FixGroup {
	...
	byte[] encodedText = new byte[FixUtils.FIX_MAX_STRING_TEXT_LENGTH];		
		...
		FixInstrmtLegSecListGrp[] instrmtLegSecListGrp;
	...
	public void encode(ByteBuffer out) {
		...
		for (FixInstrmtLegSecListGrp fixInstrmtLegSecListGrp : instrmtLegSecListGrp) fixInstrmtLegSecListGrp.encode(out);
