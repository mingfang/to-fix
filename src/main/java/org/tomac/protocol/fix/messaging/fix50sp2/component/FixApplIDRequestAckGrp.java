...
public class FixApplIDRequestAckGrp
{
	...
	public void getAll(int noApplIDs, ByteBuffer buf) throws FixSessionException, FixGarbledException {
		...
		if (group == null || group.length < noApplIDs) {
			...
			for ( int i = 0; i < noApplIDs; i++ ) group[i] = new ApplIDRequestAckGrp();
	}
...
public class ApplIDRequestAckGrp implements FixComponent
{
	...
	public long applResponseError = 0;
	...
	public void clear()
	{
		...
		applResponseError = Long.MAX_VALUE;		
		nestedParties.clear();
	}
	...
	public void getAllGroup(ByteBuffer buf) throws FixSessionException, FixGarbledException
	{
		...
		int lastTagPosition = buf.position();
			...
			if(id == FixTags.APPLRESPONSEERROR_INT) {
				applResponseError = FixUtils.getTagIntValue(null ,id ,value );
	...
	public boolean isSet()
	{
		...
		if (FixUtils.isSet(applResponseError)) return true;
	...
	public void encode( ByteBuffer out )
	{
		...
		if (FixUtils.isSet(applResponseError)) FixUtils.putFixTag( out, FixTags.APPLRESPONSEERROR_INT, applResponseError);
	...
	**/
	...
	public String toString() {
		...
		String s = "";
			...
			if (FixUtils.isSet(applResponseError)) s += "ApplResponseError(1354)=" + String.valueOf(applResponseError) + sep;
	...
	public boolean equals(Object o) {
		...
		if (!( applResponseError==msg.applResponseError)) return false;
