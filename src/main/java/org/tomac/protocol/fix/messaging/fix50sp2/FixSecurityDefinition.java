...
public class FixSecurityDefinition extends FixMessage
{
	...
	public FixSecurityDefinition() {
		...
		msgType = MsgTypes.SECURITYDEFINITION_INT;
	...
	public void getAll() throws FixSessionException, FixGarbledException
	{
		...
		while ( ( id = FixUtils.getTagId( buf ) ) >= 0 )
		{
			...
			case FixTags.SECURITYREPORTID_INT:
				securityReportID = FixUtils.getTagIntValue(MsgTypes.SECURITYDEFINITION ,id ,value );
				break;

			case FixTags.CLEARINGBUSINESSDATE_INT:
				clearingBusinessDate = FixUtils.getTagStringValue(MsgTypes.SECURITYDEFINITION ,id ,value, clearingBusinessDate);
				break;
			...
			case FixTags.SECURITYREQID_INT:
				securityReqID = FixUtils.getTagStringValue(MsgTypes.SECURITYDEFINITION ,id ,value, securityReqID);
				break;

			case FixTags.SECURITYRESPONSEID_INT:
				securityResponseID = FixUtils.getTagStringValue(MsgTypes.SECURITYDEFINITION ,id ,value, securityResponseID);
				break;

			case FixTags.SECURITYRESPONSETYPE_INT:
				securityResponseType = FixUtils.getTagIntValue(MsgTypes.SECURITYDEFINITION ,id ,value );
			...
			case FixTags.CORPORATEACTION_INT:
				corporateAction = FixUtils.getTagStringValue(MsgTypes.SECURITYDEFINITION ,id ,value, corporateAction);
			...
			case FixTags.NOUNDERLYINGS_INT:
				undInstrmtGrp.noUnderlyings = FixUtils.getTagIntValue( MsgTypes.SECURITYDEFINITION ,FixTags.NOUNDERLYINGS_INT ,value );
				undInstrmtGrp.getAll(undInstrmtGrp.noUnderlyings, value );
				break;

			case FixTags.CURRENCY_INT:
				currency = FixUtils.getTagStringValue(MsgTypes.SECURITYDEFINITION ,id ,value, currency);
				break;

			case FixTags.TEXT_INT:
				text = FixUtils.getTagStringValue(MsgTypes.SECURITYDEFINITION ,id ,value, text);
				break;

			case FixTags.ENCODEDTEXTLEN_INT:
				encodedTextLen = FixUtils.getTagIntValue(MsgTypes.SECURITYDEFINITION ,id ,value );
				break;

			case FixTags.ENCODEDTEXT_INT:
				encodedText = FixUtils.getTagStringValue(MsgTypes.SECURITYDEFINITION ,id ,value, encodedText);
				break;

			case FixTags.NOSTIPULATIONS_INT:
				stipulations.noStipulations = FixUtils.getTagIntValue( MsgTypes.SECURITYDEFINITION ,FixTags.NOSTIPULATIONS_INT ,value );
				stipulations.getAll(stipulations.noStipulations, value );
				break;

			case FixTags.NOLEGS_INT:
				instrmtLegGrp.noLegs = FixUtils.getTagIntValue( MsgTypes.SECURITYDEFINITION ,FixTags.NOLEGS_INT ,value );
			...
			case FixTags.NOMARKETSEGMENTS_INT:
				marketSegmentGrp.noMarketSegments = FixUtils.getTagIntValue( MsgTypes.SECURITYDEFINITION ,FixTags.NOMARKETSEGMENTS_INT ,value );
				marketSegmentGrp.getAll(marketSegmentGrp.noMarketSegments, value );
				break;

			case FixTags.TRANSACTTIME_INT:
				transactTime = FixUtils.getTagStringValue(MsgTypes.SECURITYDEFINITION ,id ,value, transactTime);
				break;

			// for a message always get the checksum
			case FixTags.CHECKSUM_INT:
				checkSum = FixUtils.getTagIntValue( MsgTypes.SECURITYDEFINITION ,FixTags.CHECKSUM_INT, value );
	...
	public void encode( ByteBuffer out )
	{
		...
		FixUtils.putFixTag( out, FixTags.MSGTYPE_INT, MsgTypes.SECURITYDEFINITION);
	...
	**/
	...
	public String toString() {
		...
		s += "MsgType(35)=" + new String(MsgTypes.SECURITYDEFINITION) + sep;
