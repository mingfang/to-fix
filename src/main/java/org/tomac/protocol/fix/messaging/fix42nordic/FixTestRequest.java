...
public class FixTestRequest extends FixMessage
{
	...
	public void getAll() throws FixSessionException, FixGarbledException
	{
		...
		while ( ( id = FixUtils.getTagId( buf ) ) >= 0 )
		{
			...
			case FixTags.TESTREQID_INT:
				testReqID = FixUtils.getTagStringValue(MsgTypes.TESTREQUEST ,id ,value, testReqID);
				break;

			// for a message always get the checksum
			case FixTags.CHECKSUM_INT:
				checkSum = FixUtils.getTagIntValue( MsgTypes.TESTREQUEST ,FixTags.CHECKSUM_INT, value );
	...
	private int checkRequiredTags() {
		...
		if (! FixUtils.isSet(testReqID) ) return FixTags.TESTREQID_INT;
	...
	public void encode( ByteBuffer out )
	{
		...
		FixUtils.putFixTag( out, FixTags.MSGTYPE_INT, MsgTypes.TESTREQUEST);
		...
		FixUtils.putFixTag( out, FixTags.TESTREQID_INT, testReqID, 0, Utils.lastIndexTrim(testReqID, (byte)0) );
	...
	**/
	...
	public String toString() {
		...
		s += "MsgType(35)=" + new String(MsgTypes.TESTREQUEST) + sep;
		...
		try {
			...
			if (FixUtils.isSet(deliverToSubID)) s += "DeliverToSubID(129)=" + new String(deliverToSubID) + sep;
			 ...
			 s += "TestReqID(112)=" + new String(testReqID) + sep;
