...
public class FixListExecute extends FixMessage
{
	...
	public FixListExecute() {
		...
		msgType = MsgTypes.LISTEXECUTE_INT;
	...
	public void encode( ByteBuffer out )
	{
		...
		FixUtils.putFixTag( out, FixTags.MSGTYPE_INT, MsgTypes.LISTEXECUTE);
	...
	**/
	...
	public String toString() {
		...
		s += "MsgType(35)=" + new String(MsgTypes.LISTEXECUTE) + sep;
