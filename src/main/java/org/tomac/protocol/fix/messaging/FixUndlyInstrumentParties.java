...
public class FixUndlyInstrumentParties extends FixGroup {
	...
	long underlyingInstrumentPartyRole = 0;		
		FixUndlyInstrumentPtysSubGrp[] undlyInstrumentPtysSubGrp;
	...
	public void encode(ByteBuffer out) {
		...
		for (FixUndlyInstrumentPtysSubGrp fixUndlyInstrumentPtysSubGrp : undlyInstrumentPtysSubGrp) fixUndlyInstrumentPtysSubGrp.encode(out);
	}
