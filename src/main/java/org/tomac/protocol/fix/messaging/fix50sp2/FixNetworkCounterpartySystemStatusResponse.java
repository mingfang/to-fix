	...
	public void getAll() throws FixSessionException, FixGarbledException
	{
		...
		while ( ( id = FixUtils.getTagId( buf ) ) > 0 )
		{
			...
			case FixTags.NETWORKSTATUSRESPONSETYPE_INT:
				...
				if (!NetworkStatusResponseType.isValid(networkStatusResponseType) ) throw new FixSessionException(buf, "Invalid enumerated value(" + networkStatusResponseType + ") for tag: " + id );
				break;
