...
public class FixNetworkCounterpartySystemStatusResponse extends FixMessage
{
	...
	public long networkStatusResponseType = 0;
	...
	public void clear()
	{
		...
		networkStatusResponseType = Long.MAX_VALUE;		
	...
	public void getAll() throws FixSessionException, FixGarbledException
	{
		...
		while ( ( id = FixUtils.getTagId( buf ) ) >= 0 )
		{
			...
			case FixTags.NETWORKSTATUSRESPONSETYPE_INT:
				networkStatusResponseType = FixUtils.getTagIntValue(MsgTypes.NETWORKCOUNTERPARTYSYSTEMSTATUSRESPONSE ,id ,value );
				if (!NetworkStatusResponseType.isValid(networkStatusResponseType) ) throw new FixSessionException(SessionRejectReason.VALUE_IS_INCORRECT_OUT_OF_RANGE_FOR_THIS_TAG, ("Invalid enumerated value(" + networkStatusResponseType + ") for tag").getBytes(), id, FixUtils.getMsgType(msgType) );
				break;

			case FixTags.NETWORKREQUESTID_INT:
				networkRequestID = FixUtils.getTagStringValue(MsgTypes.NETWORKCOUNTERPARTYSYSTEMSTATUSRESPONSE ,id ,value, networkRequestID);
				break;

			case FixTags.NETWORKRESPONSEID_INT:
				networkResponseID = FixUtils.getTagStringValue(MsgTypes.NETWORKCOUNTERPARTYSYSTEMSTATUSRESPONSE ,id ,value, networkResponseID);
				break;

			case FixTags.LASTNETWORKRESPONSEID_INT:
				lastNetworkResponseID = FixUtils.getTagStringValue(MsgTypes.NETWORKCOUNTERPARTYSYSTEMSTATUSRESPONSE ,id ,value, lastNetworkResponseID);
				break;

			case FixTags.NOCOMPIDS_INT:
				compIDStatGrp.noCompIDs = FixUtils.getTagIntValue( MsgTypes.NETWORKCOUNTERPARTYSYSTEMSTATUSRESPONSE ,FixTags.NOCOMPIDS_INT ,value );
				compIDStatGrp.getAll(compIDStatGrp.noCompIDs, value );
				break;

			// for a message always get the checksum
			case FixTags.CHECKSUM_INT:
				checkSum = FixUtils.getTagIntValue( MsgTypes.NETWORKCOUNTERPARTYSYSTEMSTATUSRESPONSE ,FixTags.CHECKSUM_INT, value );
	...
	public void encode( ByteBuffer out )
	{
		...
		FixUtils.putFixTag( out, FixTags.MSGTYPE_INT, MsgTypes.NETWORKCOUNTERPARTYSYSTEMSTATUSRESPONSE);
	...
	**/
	...
	public String toString() {
		...
		s += "MsgType(35)=" + new String(MsgTypes.NETWORKCOUNTERPARTYSYSTEMSTATUSRESPONSE) + sep;
	...
	public boolean equals(Object o) {
		...
		if (!( networkStatusResponseType==msg.networkStatusResponseType)) return false;
